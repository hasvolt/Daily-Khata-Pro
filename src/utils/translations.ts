...
export const TRANSLATIONS: Record<AppLanguage, Translations> = {
  en: {
    ...
    home: {
      ...
      thisMonthNet: 'Monthly Savings',
      todayIncome: 'Today Income',
      todayExpense: 'Today Expense',
      todayNet: "Today's Savings",
      dailySummaryHeading: 'Today (Daily)',
      monthlySummaryHeading: 'This Month (Monthly)',
      netSavings: 'Net Savings',
      todayCashFlow: "Today's Activity",
      sixFundsHeading: 'Smart Fund Balance Pots',
      sixFundsSub: 'Automated savings and expense pots based on discipline rules',
      allocationRule: 'Split Rule',
      recentTransactions: 'Recent Transactions',
      viewAllRecord: 'View All Records →',
      ...
      calculator: 'Smart Fund Split Calculator',
    ...
    add: {
      ...
      incomeSplitsPreview: 'Automatic Smart Fund Allocation Breakdown:',
    ...
    history: {
      heading: 'Passbook & Transaction Records',
      sub: 'All your income, expense and savings entries in one place.',
      ...
      deleteConfirmDesc: 'This will permanently remove this transaction from your records.'
    },
    reports: {
      heading: 'Reports & Analytics',
      sub: 'Income vs expense charts, fund breakdown and savings summary.',
      exportCsv: 'Export CSV / Excel',
      printStatement: 'Print Statement',
      monthSelector: 'Select Month',
      incomeVsExpense: 'Monthly Income vs Expense',
      savingsRate: 'Savings Rate & Discipline',
      fundDistribution: 'Fund Pot Balances',
      topExpenseCategories: 'Top Expense Categories',
      financialHealthAnalysis: 'Financial Health Score',
      emergencyRunway: 'Emergency Fund Buffer',
      runwayMonths: 'Months of expense coverage available',
      healthRecommendations: 'Smart Recommendations'
    },
    simulator: {
      title: 'Smart Fund Split Simulator & Calculator',
      ...
      breakdownHeading: 'Calculated Smart Fund Distribution'
    },
    calculator: {
      title: 'Smart Fund Income Split Calculator',
  ...
  hi: {
    ...
    header: {
      ...
      simulator: 'स्मार्ट फंड कैलकुलेटर',
    ...
    home: {
      ...
      sixFundsHeading: 'स्मार्ट फंड बैलेंस पॉट्स',
      ...
      calculator: 'स्मार्ट फंड विभाजन सिम्युलेटर',
    ...
    add: {
      ...
      incomeSplitsPreview: 'स्मार्ट फंड में स्वचालित विभाजन पूर्वावलोकन:',
    ...
    simulator: {
      title: 'स्मार्ट फंड विभाजन सिम्युलेटर और कैलकुलेटर',
      subtitle: 'किसी भी वेतन या व्यावसायिक कमाई का स्मार्ट फंड गणितीय विभाजन तुरंत देखें।',
      ...
      breakdownHeading: 'गणना किया गया स्मार्ट फंड विभाजन'
    },
    calculator: {
      title: 'स्मार्ट फंड आय विभाजन कैलकुलेटर',
      subtitle: 'अपनी कमाई का लाइव स्मार्ट फंड विभाजन कैलकुलेट करें।',
  ...
  hinglish: {
    ...
    header: {
      ...
      simulator: 'Smart Fund Calculator',
      offlineBadge: '100% Offline & Private'
    },
    home: {
      ...
      healthScore: 'Financial Health Score',
      calculator: 'Smart Fund Split Simulator',
    ...
    add: {
      ...
      incomeSplitsPreview: 'Automatic Smart Fund Split Preview:',
    ...
    reports: {
      ...
      fundDistribution: 'Smart Fund Balances Distribution',
    ...
    simulator: {
      ...
      breakdownHeading: 'Calculated Smart Fund Split'
    },
    calculator: {
      title: 'Smart Fund Income Split Calculator',
      ...
      presets: 'Quick Amounts',
      calculatedBreakdown: 'Calculated Smart Fund Split',
