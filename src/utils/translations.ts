...
export const TRANSLATIONS: Record<AppLanguage, Translations> = {
  en: {
    ...
    appSubtitle: 'Universal Daily Financial Ledger & 7-Fund Capital Engine',
    nav: {
      home: 'Khata',
      add: 'Add +',
      tracker: 'Work & Life',
    ...
    home: {
      ...
      sixFundsHeading: '7-Fund Money Pots',
      ...
      calculator: '7-Fund Split Simulator',
    ...
    add: {
      ...
      incomeSplitsPreview: 'Automatic 7-Fund Allocation Breakdown:',
    ...
    simulator: {
      title: '7-Fund Split Simulator & Calculator',
      ...
      breakdownHeading: 'Calculated 7-Fund Distribution'
    },
    calculator: {
      title: '7-Fund Income Split Calculator',
      ...
      calculatedBreakdown: 'Calculated 7-Fund Distribution',
      applyToIncome: 'Apply Amount to Income Entry'
    },
    settings: {
      title: 'Settings & Customization',
      subtitle: 'Theme, Language, Custom Options, 7-Fund Rule Customizer, Backups & Privacy',
      tabPreferences: 'Preferences',
      tabCustomOptions: 'Custom Categories & Options',
      tabRules: '7-Fund Rules',
      ...
      customPercentagesHeading: '7-Fund Allocation Percentage Customizer',
      ...
      resetRuleBtn: 'Reset to Recommended 7-Fund Rules',
  ...
  hi: {
    ...
    appSubtitle: 'सार्वभौमिक वित्तीय लेजर व 7-फंड स्मार्ट विभाजन इंजन',
    nav: {
      home: 'खाता',
      add: 'जोड़ें +',
      tracker: 'काम व जीवन',
    ...
    home: {
      ...
      sixFundsHeading: '7-फंड बैलेंस पॉट्स',
      ...
      noEntriesSub: 'अपनी दैनिक कमाई या खर्च दर्ज करके 7-फंड विभाजन सक्रिय करें।',
      ...
      calculator: '7-फंड विभाजन सिम्युलेटर',
    ...
    add: {
      ...
      incomeSplitsPreview: '7-फंड में स्वचालित विभाजन पूर्वावलोकन:',
    ...
    simulator: {
      title: '7-फंड विभाजन सिम्युलेटर और कैलकुलेटर',
      subtitle: 'किसी भी वेतन या व्यावसायिक कमाई का 7-फंड गणितीय विभाजन तुरंत देखें।',
      ...
      breakdownHeading: 'गणना किया गया 7-फंड विभाजन'
    },
    calculator: {
      title: '7-फंड आय विभाजन कैलकुलेटर',
      subtitle: 'अपनी कमाई का लाइव 7-फंड विभाजन कैलकुलेट करें।',
      get enterAmount() { return `कमाई की राशि दर्ज करें (${getCurrencyConfig(getCurrentLanguage()).symbol})`; },
      presets: 'त्वरित राशि',
      calculatedBreakdown: 'गणना किया गया 7-फंड विभाजन',
      applyToIncome: 'इस राशि को कमाई में लागू करें'
    },
    settings: {
      title: 'सेटिंग्स और कस्टम विकल्प',
      subtitle: 'थीम, भाषा, कस्टम श्रेणियां, 7-फंड प्रतिशत नियम, बैकअप और प्राइवेसी',
      ...
      customPercentagesHeading: '7-फंड प्रतिशत विभाजन अनुकूलक',
      ...
      resetRuleBtn: 'अनुशंसित 7-फंड नियमों पर रीसेट करें',
  ...
  hinglish: {
    ...
    add: {
      ...
      incomeSplitsPreview: 'Automatic 7-Fund Split Preview:',
    ...
    reports: {
      ...
      fundDistribution: '7-Fund Balances Distribution',
    ...
    simulator: {
      ...
      breakdownHeading: 'Calculated 7-Fund Split'
    },
    calculator: {
      title: '7-Fund Income Split Calculator',
      ...
      presets: 'Quick Amounts',
      calculatedBreakdown: 'Calculated 7-Fund Split',
      applyToIncome: 'Income Entry Mein Apply Karein'
    },
    settings: {
      title: 'Settings & Customization',
      subtitle: 'Theme, Language, Custom Categories, 7-Fund Rules, Backups & Privacy',
      tabPreferences: 'Preferences',
      tabCustomOptions: 'Custom Categories & Options',
      tabRules: '7-Fund Rules',
      tabBackup: 'Data Backup & Export',
