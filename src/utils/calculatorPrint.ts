...
<body>
  ...
  <div style="margin-top: 24px; padding-top: 10px; border-top: 1.5px solid #e2e8f0; font-size: 10.5px; color: #64748b; text-align: center;">
    <span>• End of Calculation Slip •</span>
  </div>

  <div class="footer" style="margin-top: 14px; padding: 10px 14px; background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 8px; display: flex; justify-content: space-between; align-items: center; font-size: 10px; color: #64748b; page-break-inside: avoid; break-inside: avoid;">
    <div>
      <div style="font-weight: 700; color: #0f172a; font-size: 10.5px;">Generated by Daily Khata Pro</div>
      <div style="font-size: 9px; color: #64748b; margin-top: 2px;">www.rozfiber.com • 100% Offline &amp; Private</div>
    </div>
    <div style="text-align: right; font-size: 9px; color: #64748b;">
      <span>Verified Digital Computation</span>
    </div>
  </div>
</body>
</html>`;
