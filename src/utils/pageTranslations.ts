...
export const PAGE_TRANSLATIONS: Record<AppLanguage, PageTranslations> = {
  en: {
    ...
    developer: {
      ...
      subtitle: 'Built with dedication by MD Zafeer Hasan (YAZDAAN) • Dedicated to digital privacy, security research & public resources.',
      backToHome: 'Back to Home',
      bioTitle: 'About MD Zafeer Hasan (YAZDAAN)',
  ...
  hinglish: {
    ...
    developer: {
      badge: 'Developer Profile',
      title: 'Developer Profile & Creator',
      subtitle: 'Created by MD Zafeer Hasan (YAZDAAN) • Dedicated to digital privacy, security research & public resources.',
      backToHome: 'Home Par Wapas Jayein',
      bioTitle: 'About MD Zafeer Hasan (YAZDAAN)',
  ...
  es: {
    ...
    developer: {
      ...
      subtitle: 'Creado por MD Zafeer Hasan (YAZDAAN) • Enfocado en privacidad y software ético.',
      backToHome: 'Volver al Inicio',
      bioTitle: 'Sobre MD Zafeer Hasan (YAZDAAN)',
      bioDesc: 'MD Zafeer Hasan (YAZDAAN) es un ingeniero de software y creador de código abierto enfocado en herramientas rápidas y éticas.',
  ...
  fr: {
    ...
    developer: {
      ...
      subtitle: 'Conçu avec passion par MD Zafeer Hasan (YAZDAAN).',
      backToHome: 'Retour à l’accueil',
      bioTitle: 'À propos de MD Zafeer Hasan (YAZDAAN)',
