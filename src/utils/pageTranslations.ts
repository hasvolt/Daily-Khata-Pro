...
export const PAGE_TRANSLATIONS: Record<AppLanguage, PageTranslations> = {
  en: {
    ...
    developer: {
      ...
      subtitle: 'Built with dedication by Daily Khata Pro (YAZDAAN) • Dedicated to digital privacy, security research & public resources.',
      backToHome: 'Back to Home',
      bioTitle: 'About Daily Khata Pro (YAZDAAN)',
      bioDesc: 'Daily Khata Pro is an independent open-source project focused on building privacy-first digital tools for humanity.',
    ...
    common: {
      ...
      safeOffline: 'Sandboxed Local Storage • Zero Telemetry',
  ...
  hi: {
    about: {
      ...
      missionP2: 'पारंपरिक वित्त ऐप्स आपका डेटा दूरस्थ सर्वर पर अपलोड करते हैं। डेली खाता: प्रो में आपका डेटा कभी भी आपके फ़ोन या लैपटॉप से बाहर नहीं जाता। यह MIT ओपन सोर्स लाइसेंस के तहत हमेशा उपलब्ध है।',
    ...
    developer: {
      ...
      visionDesc: 'हर नागरिक, फ्रीलांसर और छोटे व्यापारी को एक ऐसा शक्तिशाली वित्तीय सिस्टम देना जो पूरी तरह सुरक्षित हो, ऑफ़लाइन चले और कभी उपयोगकर्ता डेटा का दुरुपयोग न करे।',
    ...
    common: {
      ...
      safeOffline: 'लोकल सैंडबॉक्स स्टोरेज • शून्य टेलीमेट्री',
  ...
  hinglish: {
    ...
    developer: {
      badge: 'Developer Profile',
      title: 'Developer Profile & Creator',
      subtitle: 'Created by Daily Khata Pro (YAZDAAN) • Dedicated to digital privacy, security research & public resources.',
      backToHome: 'Home Par Wapas Jayein',
      bioTitle: 'About Daily Khata Pro (YAZDAAN)',
      bioDesc: 'Daily Khata Pro ek independent open-source project hai jo clean, secure aur public utility tools banata hai.',
      skillsTitle: 'Professional Roles & Domains',
  ...
  es: {
    ...
    developer: {
      ...
      subtitle: 'Creado por Daily Khata Pro (YAZDAAN) • Enfocado en privacidad y software ético.',
      backToHome: 'Volver al Inicio',
      bioTitle: 'Sobre Daily Khata Pro (YAZDAAN)',
      bioDesc: 'Daily Khata Pro (YAZDAAN) es un ingeniero de software y creador de código abierto enfocado en herramientas rápidas y éticas.',
  ...
  fr: {
    ...
    developer: {
      ...
      subtitle: 'Conçu avec passion par Daily Khata Pro (YAZDAAN).',
      backToHome: 'Retour à l’accueil',
      bioTitle: 'À propos de Daily Khata Pro (YAZDAAN)',
