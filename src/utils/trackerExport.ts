...
export const printTrackerData = (workLogs: WorkLog[], dailyLifeLogs: DailyLifeLog[]) => {
  const htmlContent = `
    ...
    <body>
      ...
      <div class="running-page-footer" style="margin-top: 40px; padding-top: 10px; border-top: 1px solid #cbd5e1; display: flex; align-items: center; justify-content: space-between; font-size: 8.5pt; color: #64748b; background: #ffffff;">
