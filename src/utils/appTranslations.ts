...
export const APP_TRANSLATIONS: Record<AppLanguage, AppTranslationBundle> = {
  en: {
    ...
    manual: {
      ...
      sections: [
        ...
        { id: 'six_funds', title: '4. 6-Fund Formula Allocation', subtitle: 'Automated 30/35/5/11.25/7.5/11.25 capital splits' },
    ...
    settings: {
      ...
      ruleSavedSuccess: '6-Fund allocation rule updated successfully!',
  ...
  hi: {
    ...
    manual: {
      ...
      subtitle: 'वित्तीय अनुशासन, 6-फंड फॉर्मूला व धन प्रबंधन की आधिकारिक मार्गदर्शिका',
      ...
      sections: [
        ...
        { id: 'six_funds', title: '4. 6-फंड फॉर्मूला एलोकेशन', subtitle: '30/35/5/11.25/7.5/11.25 स्वचालित पूंजी विभाजन नियम' },
    ...
    settings: {
      ...
      ruleSavedSuccess: '6-फंड आवंटन नियम सफलतापूर्वक सहेजे गए!',
      ruleResetSuccess: 'डिफ़ॉल्ट 6-फंड नियमों पर रीसेट कर दिया गया।',
    ...
    calc: {
      ...
      subtitle: '7-इन-1 स्मार्ट वित्तीय कैलकुलेटर (6-फंड, SIP, EMI, GST, डिस्काउंट, महंगाई व स्टैंडर्ड)',
      tabStandard: 'साधारण कैलकुलेटर',
      tabFunds: '6-फंड विभाजन',
    ...
    developer: {
      ...
      name: 'MD Zafeer Hasan',
      alias: '(YAZDAAN)',
      role: 'स्वतंत्र डेवलपर एवं संस्थापक',
  ...
  hinglish: {
    ...
    manual: {
      ...
      sections: [
        ...
        { id: 'six_funds', title: '4. 6-Fund Formula Allocation', subtitle: 'Automated 30/35/5/11.25/7.5/11.25 split rules' },
    ...
    settings: {
      ...
      customPercentagesHeading: '6-Fund Percentage Customizer',
      ...
      resetRuleBtn: 'Default 6-Fund Rules Par Reset Karein',
      backupHeading: 'Local Storage Backup & Restore',
      ...
      resetAllDataBtn: 'Wipe & Reset All Khata Data',
      ruleSavedSuccess: '6-Fund allocation rule successfully save ho gaya!',
