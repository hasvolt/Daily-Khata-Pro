...
export const APP_TRANSLATIONS: Record<AppLanguage, AppTranslationBundle> = {
  en: {
    ...
    safety: {
      ...
      repoTitle: 'GitHub / Daily-Khata-Pro',
    ...
    developer: {
      ...
      visionDesc: 'Daily Khata Pro is built under the MIT license, with no trackers, no external cloud dependencies, and zero-telemetry architecture.',
  ...
  hi: {
    ...
    developer: {
      ...
      alias: '(Unknown)',
      role: 'स्वतंत्र डेवलपर • ओपन-सोर्स क्रिएटर',
      ...
      visionDesc: 'डेली खाता: प्रो MIT लाइसेंस के तहत पूरी तरह सुरक्षित और निजी, बिना किसी बाहरी ट्रैकर या कॉर्पोरेट टेलीमेट्री के बनाया गया है।',
    ...
    brand: {
      ...
      tagline: '100% फ्री • कोई विज्ञापन नहीं • कोई सब्सक्रिप्शन नहीं',
      offlineBadge: '100% फ्री और सुरक्षित'
    }
  },
  hinglish: {
    menu: {
