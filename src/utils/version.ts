/**
 * Centralized Application Version Single Source of Truth
 * Ensures 100% version consistency across all screens, modals, headers, and diagnostics.
 */

export const APP_VERSION = '2.6.0';
export const APP_VERSION_TAG = 'v2.6.0';
...
export const APP_VERSION_FOOTER = `Version ${APP_VERSION} · Production Ready · Offline First · Free Open Source`;
