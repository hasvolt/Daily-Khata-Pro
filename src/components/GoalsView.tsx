      ...
      >
        ...
        <div className="relative flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div className="space-y-1.5 min-w-0">
            <div className="flex items-center gap-2 text-[12px] sm:text-[13px] uppercase tracking-wider text-[var(--theme-text-dim,#94A3B8)] font-bold">
              <Trophy className="w-4 h-4 text-[var(--theme-primary,#38BDF8)] shrink-0" />
              <span>Financial Milestones</span>
            </div>
            <div className="font-serif-display text-[26px] sm:text-[30px] font-bold text-[var(--theme-text,#F8FAFC)] num leading-tight truncate">
              {formatCurrency(totalSaved, privacyMask)}
              <span className="text-[15px] sm:text-[16px] font-sans font-normal text-[var(--theme-text-dim,#94A3B8)] ml-2">
                / {formatCurrency(totalTarget, privacyMask)} Target
              </span>
            </div>
            <p className="text-[13px] sm:text-[13.5px] text-[var(--theme-text-dim,#94A3B8)] truncate">
              {goals.length > 0
      ...
      {goals.length === 0 ? (
        <div className="bg-[var(--theme-card,#132438)] border border-[var(--theme-border,#213E61)] rounded-2xl p-6 sm:p-8 space-y-6 shadow-lg text-center">
          ...
          <div className="space-y-2">
            <h3 className="font-serif-display text-[20px] sm:text-[22px] font-bold text-[var(--theme-text,#F8FAFC)]">
              No Active Goals Yet
            </h3>
            <p className="text-[13.5px] sm:text-[14px] text-[var(--theme-text-dim,#94A3B8)] max-w-md mx-auto leading-relaxed">
          ...
          <div className="border-t border-[var(--theme-border,#213E61)] pt-5 text-left space-y-3">
            <div className="text-[12px] sm:text-[12.5px] uppercase tracking-wider text-[var(--theme-text-dim,#94A3B8)] font-bold flex items-center gap-2">
                  ...
                  >
                    <div className="flex items-center gap-3 min-w-0">
                      ...
                      <div className="min-w-0">
                        <div className="text-[14px] sm:text-[14.5px] font-bold text-[var(--theme-text,#F8FAFC)] group-hover:text-[var(--theme-primary,#38BDF8)] transition-colors truncate">
                          {preset.title}
                        </div>
                        <div className="text-[12px] sm:text-[12.5px] text-[var(--theme-text-dim,#94A3B8)]">
        ...
        <div className="text-center text-[var(--theme-text-dim,#94A3B8)] py-12 px-4 border border-dashed border-[var(--theme-border,#213E61)] rounded-2xl bg-[var(--theme-card,#132438)]/30">
            ...
            return (
              ...
              >
                ...
                <div className="flex justify-between items-start gap-2">
                  <div className="flex items-start gap-3 min-w-0 flex-1">
                    ...
                    <div className="space-y-1 text-left min-w-0 flex-1">
                      <div className="flex items-center gap-2 flex-wrap">
                        <h4 className="font-serif-display text-[16px] sm:text-[17px] font-bold text-[var(--theme-text,#F8FAFC)] leading-snug truncate">
                          {goal.title}
                        </h4>
                        {isDone ? (
                      ...
                      <div className="flex items-center gap-2 text-[12px] text-[var(--theme-text-dim,#94A3B8)] flex-wrap">
                        {goal.linkedFund && (
                          <span className="truncate">
                            Pot: <strong className="text-[var(--theme-text,#F8FAFC)]">{FUND_LABELS[goal.linkedFund]}</strong>
                          </span>
                        )}
                        {daysInfo && (
                          <span className={`flex items-center gap-1 ${daysInfo.isLate ? 'text-[#FCA5A5]' : 'text-[var(--theme-text-dim,#94A3B8)]'} shrink-0`}>
                  ...
                  <div className="flex items-center gap-1 shrink-0 pl-1">
                    <button
                      ...
                      title="Edit Goal"
                      className="p-2 rounded-xl text-[var(--theme-text-dim,#94A3B8)] hover:text-[var(--theme-primary,#38BDF8)] hover:bg-[var(--theme-surface,#0E1A29)] transition-colors cursor-pointer"
                    >
                    ...
                    <button
                      ...
                      title="Delete Goal"
                      className="p-2 rounded-xl text-[var(--theme-text-dim,#94A3B8)] hover:text-[#EF4444] hover:bg-[var(--theme-surface,#0E1A29)] transition-colors cursor-pointer"
                    >
                ...
                <div className="bg-[var(--theme-bg,#070E18)] p-3 sm:p-3.5 rounded-xl border border-[var(--theme-border,#213E61)] flex justify-between items-center text-[13px]">
                  <div>
                    <span className="text-[11px] text-[var(--theme-text-dim,#94A3B8)] uppercase block font-bold">Saved</span>
                  ...
                  <div className="text-right">
                    <span className="text-[11px] text-[var(--theme-text-dim,#94A3B8)] uppercase block font-bold">Target</span>
                    <span className="font-serif-display text-[17px] sm:text-[19px] font-bold text-[var(--theme-text,#F8FAFC)] num">
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="flex justify-between text-[11.5px] text-[var(--theme-text-dim,#94A3B8)] font-medium">
                  ...
                  <button
                    ...
                    className={`min-h-[40px] py-2.5 px-3.5 rounded-xl text-[13px] font-bold flex items-center justify-center gap-1.5 transition-all cursor-pointer ${
                      isDone
                        ...
                        : 'bg-[var(--theme-card,#132438)] text-[var(--theme-text-dim,#94A3B8)] border border-[var(--theme-border,#213E61)] hover:text-[var(--theme-text,#F8FAFC)]'
                    }`}
                  >
