  ...
  return (
    ...
    >
      ...
      <div className="pt-2 sm:pt-3 mt-3 sm:mt-4 border-t border-slate-200 print:border-slate-300 print:pt-1.5 print:mt-2 flex items-center justify-center text-center invoice-branding-footer print-break-inside-avoid">
        <p className="text-[10.5px] text-slate-500 print:text-slate-600 font-normal">
          Generated by Daily Khata Pro • <span className="font-mono text-slate-500 print:text-slate-600 font-normal">www.rozfiber.com</span>
        </p>
      </div>
    </div>
  );
