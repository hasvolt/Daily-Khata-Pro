    ...
    <div className="w-full space-y-5 animate-in fade-in duration-200 text-left">
      ...
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3">
        ...
        <div className="relative flex-1">
          <Search className="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 text-[var(--theme-text-dim,#94A3B8)]" />
          <input
            type="text"
          ...
          {searchQuery && (
            <button
              ...
              className="absolute right-3.5 top-1/2 -translate-y-1/2 text-[11px] font-bold text-[var(--theme-text-dim,#94A3B8)] hover:text-[var(--theme-text,#F8FAFC)] p-1 cursor-pointer"
            >
              Clear
            </button>
          )}
      ...
      {uniqueMonths.length > 0 && (
        <div className="flex items-center justify-between mt-2 mb-1 p-1.5 sm:p-2 rounded-xl bg-[var(--theme-card,#132438)] border border-[var(--theme-border,#213E61)] shadow-sm w-full no-print">
          <button
            ...
            className="p-1.5 sm:p-2 rounded-lg border border-[var(--theme-border,#213E61)] bg-[var(--theme-surface,#0E1A29)] text-[var(--theme-text-dim,#94A3B8)] hover:text-[var(--theme-primary,#38BDF8)] hover:border-[var(--theme-primary,#38BDF8)]/50 disabled:opacity-30 disabled:pointer-events-none transition-colors flex items-center justify-center shrink-0"
          >
      ...
      {entries.length > 0 && (
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between bg-[var(--theme-card,#132438)] border border-[var(--theme-border,#213E61)] rounded-xl px-3 sm:px-4 py-2 sm:py-2.5 gap-1.5 sm:gap-2">
          <span className="text-[11px] sm:text-[14px] text-[var(--theme-text-dim,#94A3B8)] truncate">
      ...
      {sortedDates.length === 0 ? (
        <div className="text-center text-[var(--theme-text-dim,#94A3B8)] py-14 px-5 text-[14.5px] border border-dashed border-[var(--theme-border,#213E61)] rounded-2xl bg-[var(--theme-card,#132438)]/40 space-y-4 shadow-sm">
          <div
          ...
          <p className="text-[13.5px] text-[var(--theme-text-dim,#94A3B8)] max-w-sm mx-auto">
            ...
            return (
              <div key={dateStr} className="w-full bg-[var(--theme-card,#132438)] border border-[var(--theme-border,#213E61)] rounded-2xl sm:rounded-3xl shadow-[0_4px_20px_rgba(0,0,0,0.08)] overflow-hidden transition-all hover:shadow-[0_8px_30px_rgba(0,0,0,0.12)]">
                ...
                <div className="flex justify-between items-center px-4 sm:px-5 py-3 sm:py-4 bg-[var(--theme-surface,#0E1A29)]/50 border-b border-[var(--theme-border,#213E61)]/50 backdrop-blur-sm">
                  ...
                  <span className="font-mono text-[11px] sm:text-[12.5px] font-semibold text-[var(--theme-text-dim,#94A3B8)] bg-[var(--theme-card,#132438)] px-2 py-1 rounded-lg border border-[var(--theme-border,#213E61)]/50">
                      ...
                      >
                        ...
                        <div className="flex items-center gap-2.5 sm:gap-3.5 flex-1 min-w-0 pr-1.5 sm:pr-2">
                          ...
                          <div className="flex flex-col gap-0.5 sm:gap-1 min-w-0 flex-1 text-left">
                            ...
                            <div className="flex items-center flex-wrap gap-1.5 text-[11px] sm:text-[12px] text-[var(--theme-text-dim,#94A3B8)] min-w-0">
                        ...
                        <div className="shrink-0 flex items-center gap-1.5 sm:gap-3 text-right max-w-[55%] sm:max-w-none">
                          ...
                          <div className="flex items-center gap-0.5 sm:gap-1 pl-1 sm:pl-1.5 border-l border-[var(--theme-border,#213E61)] shrink-0">
                            <button
                              ...
                              className="text-[var(--theme-text-dim,#94A3B8)] hover:text-[var(--theme-primary,#38BDF8)] p-1.5 sm:p-2 rounded-xl hover:bg-[var(--theme-surface,#0E1A29)] transition-colors cursor-pointer"
                            ...
                            <button
                              ...
                              className="text-[var(--theme-text-dim,#94A3B8)] hover:text-[#EF4444] p-1.5 sm:p-2 rounded-xl hover:bg-[var(--theme-surface,#0E1A29)] transition-colors cursor-pointer"
