      ...
      <div className="w-full max-w-lg bg-[var(--theme-card,#132438)] border border-[var(--theme-border,#213E61)] rounded-3xl p-5 sm:p-6 shadow-2xl space-y-4 max-h-[90vh] overflow-y-auto custom-scrollbar">
        ...
        <div className="flex items-center justify-between border-b border-[var(--theme-border,#213E61)] pb-3">
          ...
          <button
            type="button"
            onClick={onClose}
            className="p-1.5 rounded-xl text-[var(--theme-text-dim,#94A3B8)] hover:text-[var(--theme-text,#F8FAFC)] hover:bg-[var(--theme-surface,#0E1A29)] transition-colors cursor-pointer"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
          ...
          <div className="space-y-4 animate-in fade-in">
            ...
            {isExistingPinSet && (
              <div className="space-y-1.5 p-3 rounded-xl bg-[var(--theme-surface,#0E1A29)] border border-[var(--theme-border,#213E61)]">
                ...
                <input
                  ...
                  placeholder="••••"
                  className="w-full bg-[var(--theme-bg,#070E18)] border border-[var(--theme-border,#213E61)] text-[var(--theme-text,#F8FAFC)] text-[15px] font-mono rounded-xl px-3 py-2 focus:border-[var(--theme-primary,#38BDF8)] focus:outline-none"
                />
              </div>
            )}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div className="space-y-1.5">
                <div className="flex justify-between items-center text-[11.5px] font-bold text-[var(--theme-text-muted,#CBD5E1)]">
                  <span>{isHindi ? '4-अंकीय नया पिन (PIN):' : 'Set 4-Digit PIN:'}</span>
                  <button
                    type="button"
                    onClick={() => setShowPin(!showPin)}
                    className="text-[var(--theme-text-dim,#94A3B8)] hover:text-[var(--theme-primary,#38BDF8)] flex items-center gap-1 cursor-pointer font-normal text-[10.5px]"
                  >
                ...
                <input
                  ...
                  placeholder="1234"
                  className="w-full bg-[var(--theme-bg,#070E18)] border border-[var(--theme-border,#213E61)] text-[var(--theme-text,#F8FAFC)] text-[18px] font-mono font-bold tracking-widest text-center rounded-xl py-2 focus:border-[var(--theme-primary,#38BDF8)] focus:outline-none shadow-inner"
                />
              </div>

              <div className="space-y-1.5">
                <label className="text-[11.5px] font-bold text-[var(--theme-text-muted,#CBD5E1)] block">
            ...
            <div className="p-4 rounded-2xl bg-[var(--theme-bg,#070E18)] border border-[var(--theme-border,#213E61)] space-y-3">
              ...
              <div className="space-y-1.5">
                <label className="text-[11px] font-bold text-[var(--theme-text-muted,#CBD5E1)]">
                  {isHindi ? 'सुरक्षा प्रश्न चुनें:' : 'Select Security Question:'}
                </label>
                <select
                  value={selectedQuestion}
                  onChange={(e) => setSelectedQuestion(e.target.value)}
                  className="w-full bg-[var(--theme-surface,#0E1A29)] border border-[var(--theme-border,#213E61)] text-[var(--theme-text,#F8FAFC)] text-[12px] rounded-xl px-3 py-2 focus:border-[var(--theme-primary,#38BDF8)] focus:outline-none cursor-pointer"
                >
              ...
              {selectedQuestion === 'custom' && (
                <input
                  ...
                  className="w-full bg-[var(--theme-surface,#0E1A29)] border border-[var(--theme-border,#213E61)] text-[var(--theme-text,#F8FAFC)] text-[12px] rounded-xl px-3 py-2 focus:border-[var(--theme-primary,#38BDF8)] focus:outline-none"
                />
              )}
              ...
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  className="w-full bg-[var(--theme-surface,#0E1A29)] border border-[var(--theme-border,#213E61)] text-[var(--theme-text,#F8FAFC)] text-[12.5px] rounded-xl px-3 py-2 focus:border-[var(--theme-primary,#38BDF8)] focus:outline-none"
                />
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  className="w-full bg-[var(--theme-surface,#0E1A29)] border border-[var(--theme-border,#213E61)] text-[var(--theme-text-dim,#94A3B8)] text-[12px] rounded-xl px-3 py-2 focus:border-[var(--theme-primary,#38BDF8)] focus:outline-none"
                />
              </div>
            </div>
            ...
            <div className="p-3 rounded-xl bg-[var(--theme-bg,#070E18)] border border-[var(--theme-border,#213E61)] space-y-2.5">
              <div className="flex items-center justify-between">
                <span className="text-[11.5px] font-bold text-[var(--theme-text-muted,#CBD5E1)] flex items-center gap-1.5">
