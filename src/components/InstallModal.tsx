  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-black/80 backdrop-blur-xs animate-in fade-in duration-200 no-print text-left">
      <div className="bg-[var(--theme-card,#132438)] border border-[var(--theme-border,#213E61)] rounded-2xl w-full max-w-xl max-h-[92vh] flex flex-col shadow-2xl overflow-hidden">
        ...
        {/* Content Body */}
        <div className="p-4 sm:p-5 overflow-y-auto space-y-4 flex-1 text-[var(--theme-text-muted,#CBD5E1)]">
          {/* Main Action Card */}
          <div className="p-4 rounded-2xl bg-gradient-to-br from-[var(--theme-surface,#0E1A29)] to-[var(--theme-card,#132438)] border border-[var(--theme-primary,#38BDF8)]/40 shadow-lg relative overflow-hidden space-y-3.5">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3.5">
              <div className="flex items-center gap-3.5">
                ...
                <div>
                  <div className="font-bold text-[15px] text-[var(--theme-text,#F8FAFC)] flex items-center gap-2">
                  ...
                  <div className="text-[12px] text-[var(--theme-text-dim,#94A3B8)] flex items-center gap-1.5 mt-0.5">
            ...
            {installStatusMsg && (
              <div className="p-2.5 rounded-xl bg-[var(--theme-surface,#0E1A29)] border border-[var(--theme-border,#213E61)] text-[12px] text-[var(--theme-text,#F8FAFC)] flex items-center gap-2 animate-in fade-in">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
            <button
              type="button"
              onClick={handleOpenInNewTab}
              className="p-2.5 rounded-xl bg-[var(--theme-surface,#0E1A29)] border border-[var(--theme-border,#213E61)] hover:border-[var(--theme-primary,#38BDF8)] text-[12px] font-semibold text-[var(--theme-text,#F8FAFC)] flex flex-col items-center justify-center gap-1.5 transition-all cursor-pointer text-center"
            >
            ...
            <button
              ...
              className="p-2.5 rounded-xl bg-[var(--theme-surface,#0E1A29)] border border-[var(--theme-border,#213E61)] hover:border-[#10B981] text-[12px] font-semibold text-[var(--theme-text,#F8FAFC)] flex flex-col items-center justify-center gap-1.5 transition-all cursor-pointer text-center"
            >
            ...
            <button
              ...
              className="p-2.5 rounded-xl bg-[var(--theme-surface,#0E1A29)] border border-[var(--theme-border,#213E61)] hover:border-[#A855F7] text-[12px] font-semibold text-[var(--theme-text,#F8FAFC)] flex flex-col items-center justify-center gap-1.5 transition-all cursor-pointer text-center"
            >
            ...
            <button
              ...
              className="p-2.5 rounded-xl bg-[var(--theme-surface,#0E1A29)] border border-[var(--theme-border,#213E61)] hover:border-[#F59E0B] text-[12px] font-semibold text-[var(--theme-text,#F8FAFC)] flex flex-col items-center justify-center gap-1.5 transition-all cursor-pointer text-center"
            >
          ...
          <div className="space-y-3 pt-1">
            <div className="flex items-center justify-between">
              <span className="text-[11px] uppercase tracking-wider font-bold text-[var(--theme-text-dim,#94A3B8)]">
            ...
            {activeTab === 'android' && (
              <div className="bg-[var(--theme-bg,#070E18)] border border-[var(--theme-border,#213E61)] rounded-xl p-4 space-y-3 animate-in fade-in duration-150">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2 text-[13px] font-bold text-[var(--theme-text,#F8FAFC)]">
                ...
                <div className="space-y-2 text-[12.5px] text-[var(--theme-text-dim,#94A3B8)]">
                  <div className="flex items-start gap-2.5">
                    ...
                    <span>
                      {isHindi ? (
                        <>ऊपर दिए गए <strong className="text-[var(--theme-text,#F8FAFC)]">"होम स्क्रीन पर इंस्टॉल करें"</strong> बटन को दबाएं, या Chrome में ऊपर दाएं कोने पर <strong>3 डॉट्स (⋮)</strong> मेनू खोलें।</>
                      ) : (
                        <>Tap the <strong className="text-[var(--theme-text,#F8FAFC)]">"Install App Now"</strong> button above, or tap the top-right <strong>3 dots (⋮)</strong> menu in Chrome.</>
                      )}
                    </span>
                  </div>
                  ...
                  <div className="flex items-start gap-2.5">
                    ...
                    <span>
                      {isHindi ? (
                        <>मेन्यू में से <strong className="text-[var(--theme-text,#F8FAFC)]">"Install app"</strong> या <strong className="text-[var(--theme-text,#F8FAFC)]">"Add to Home screen" (होम स्क्रीन में जोड़ें)</strong> चुनें।</>
                      ) : (
                        <>Select <strong className="text-[var(--theme-text,#F8FAFC)]">"Install app"</strong> or <strong className="text-[var(--theme-text,#F8FAFC)]">"Add to Home screen"</strong> from the menu.</>
                      )}
                    </span>
                  </div>
                  ...
                  <div className="flex items-start gap-2.5">
                    ...
                    <span>
                      {isHindi ? (
                        <><strong className="text-[#10B981]">"Install"</strong> पर कन्फर्म करें। ऐप का नाम <strong className="text-[var(--theme-text,#F8FAFC)]">"Daily Khata Pro"</strong> आपके फोन की होम स्क्रीन पर आ जाएगा!</>
                      ) : (
                        <>Confirm <strong className="text-[#10B981]">"Install"</strong>. The app will be added as <strong className="text-[var(--theme-text,#F8FAFC)]">"Daily Khata Pro"</strong> on your phone screen!</>
                      )}
                    </span>
                  </div>
                </div>
              ...
              <div className="bg-[var(--theme-bg,#070E18)] border border-[var(--theme-border,#213E61)] rounded-xl p-4 space-y-3 animate-in fade-in duration-150">
                ...
                <div className="space-y-2 text-[12.5px] text-[var(--theme-text-dim,#94A3B8)]">
                  <div className="flex items-start gap-2.5">
                    ...
                    <span>
                      {isHindi ? (
                        <>Safari ब्राउज़र में सबसे नीचे दिए गए <strong className="text-[var(--theme-text,#F8FAFC)]">Share बटन ( <Share2 className="w-3.5 h-3.5 inline text-[#38BDF8]" /> )</strong> पर टैप करें।</>
                      ) : (
                        <>In Apple Safari, tap the bottom <strong className="text-[var(--theme-text,#F8FAFC)]">Share button ( <Share2 className="w-3.5 h-3.5 inline text-[#38BDF8]" /> )</strong>.</>
                      )}
                    </span>
                  </div>
                  ...
                  <div className="flex items-start gap-2.5">
                    ...
                    <span>
                      {isHindi ? (
                        <>नीचे स्क्रॉल करके <strong className="text-[var(--theme-text,#F8FAFC)]">"Add to Home Screen" ( <PlusSquare className="w-3.5 h-3.5 inline text-[#38BDF8]" /> )</strong> पर टैप करें।</>
                      ) : (
                        <>Scroll down and tap <strong className="text-[var(--theme-text,#F8FAFC)]">"Add to Home Screen" ( <PlusSquare className="w-3.5 h-3.5 inline text-[#38BDF8]" /> )</strong>.</>
                      )}
                    </span>
                  </div>
              ...
              <div className="bg-[var(--theme-bg,#070E18)] border border-[var(--theme-border,#213E61)] rounded-xl p-4 space-y-3 animate-in fade-in duration-150">
                ...
                <div className="space-y-2 text-[12.5px] text-[var(--theme-text-dim,#94A3B8)]">
                  <div className="flex items-start gap-2.5">
                    ...
                    <span>
                      {isHindi ? (
                        <>ब्राउज़र के एड्रेस बार (URL bar) के दाएं तरफ <strong className="text-[var(--theme-text,#F8FAFC)]">Install Icon (⤓)</strong> देखें या ऊपर दिए गए बटन को दबाएं।</>
                      ) : (
                        <>Look for the <strong className="text-[var(--theme-text,#F8FAFC)]">Install Icon (⤓)</strong> on the right side of the address bar or click the install button above.</>
                      )}
                    </span>
                  </div>
          ...
          <div className="space-y-2 pt-1">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
              <div className="p-3 rounded-xl bg-[var(--theme-surface,#0E1A29)] border border-[var(--theme-border,#213E61)] flex items-start gap-2.5">
                ...
                <div>
                  <div className="font-bold text-[12.5px] text-[var(--theme-text,#F8FAFC)]">
        ...
        <div className="px-5 py-3.5 border-t border-[var(--theme-border,#213E61)] bg-[var(--theme-surface,#0E1A29)] flex items-center justify-between shrink-0">
          <div className="text-[11px] text-[var(--theme-text-dim,#94A3B8)] flex items-center gap-1.5">
          ...
          <button
            type="button"
            onClick={onClose}
            className="px-4 py-1.5 rounded-xl bg-[var(--theme-card,#132438)] hover:bg-[var(--theme-border,#213E61)] text-[var(--theme-text,#F8FAFC)] font-bold text-[12px] cursor-pointer transition-colors"
          >
