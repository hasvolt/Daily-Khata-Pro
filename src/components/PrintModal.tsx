...
<body>
  <div class="watermark-bg">
    DAILY KHATA PRO<br>
    <span style="font-size: 20px; font-weight: 700; letter-spacing: 4px;">OFFICIAL FINANCIAL RECORD</span>
  </div>

  <div class="brand-header">
    <div>
      <div class="brand-title">Daily Khata Pro — Income, Expense &amp; Fund Statement</div>
      <div class="brand-sub">${FUND_ORDER.length}-Fund Systematic Money Ledger &amp; Wealth Audit</div>
    </div>
    <div style="text-align: right; font-size: 11px; color: #475569;">
      <div style="font-weight: 700; color: #0f172a;">Official App Record</div>
  ...
  <div class="sec-title">${FUND_ORDER.length}-Fund Balances (Current Position)</div>
  <table>
    <thead>
      <tr>
        <th>Fund Pot</th>
      ...
      ${
        monthEntries.length === 0
          ...
          <tr>
            ...
            <td style="color: #475569;">${e.type === 'income' ? `${FUND_ORDER.length}-Fund Split` : FUND_LABELS[e.fund || 'personal']}</td>
  ...
  <div class="doc-end-divider">
    ...
    <span>Generated by Daily Khata Pro</span>
  </div>

  <!-- Dedicated Distinct Developer Colophon & Watermark Signature at the Absolute Bottom -->
  <div class="developer-colophon-box" style="justify-content: flex-start; gap: 24px;">
    <div>
      <div style="font-weight: 700; color: #0f172a; font-size: 10.5px;">MD Zafeer Hasan (YAZDAAN)</div>
      <div style="font-size: 9px; color: #64748b;">Developer &amp; Creator</div>
    </div>
    <div style="border-left: 1px solid #e2e8f0; padding-left: 24px;">
      <div style="font-family: monospace; font-size: 9px; font-weight: 700; color: #0f172a; letter-spacing: 0.5px;">POWERED BY HASVOLT</div>
