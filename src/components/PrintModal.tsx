        ...
        <div className="p-5 sm:p-6 overflow-y-auto space-y-5 bg-[var(--theme-bg,#070E18)] text-[#F8FAFC] text-[13px] leading-relaxed flex-1 max-h-[calc(92vh-180px)]">
          ...
          <div className="bg-[var(--theme-surface,#0E1A29)] border border-[var(--theme-border,#213E61)] rounded-xl p-4 no-print">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div className="space-y-3">
                <div className="text-[10px] font-bold text-[#94A3B8] uppercase">From (Your Details)</div>
                <input 
                  type="text" 
              ...
              <div className="space-y-3">
                <div className="text-[10px] font-bold text-[#94A3B8] uppercase">To (Client Details)</div>
                <input 
                  type="text" 
          ...
          <div className="border-b-2 border-[#FFC700] pb-3 flex justify-between items-start gap-4">
            ...
            <div className="text-right text-[11px] text-[#94A3B8]">
              <div>Period: <strong className="text-[#F8FAFC]">{reportPeriodLabel}</strong></div>
