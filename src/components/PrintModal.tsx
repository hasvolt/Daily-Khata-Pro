  ...
  const generateStatementBodyContent = () => {
    return `
      <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Arial, sans-serif; color: #0f172a; line-height: 1.45; background: #fff; max-width: 820px; margin: 0 auto; padding: 12px 16px;">
        ...
        <div style="margin-top: 24px; padding-top: 8px; border-top: 1.5px solid #e2e8f0; font-size: 10px; color: #64748b; display: flex; justify-content: space-between; align-items: center; page-break-inside: avoid;">
