      ...
      <div className="bg-[var(--theme-card,#132438)] border border-[var(--theme-border,#213E61)] rounded-2xl w-full max-w-lg max-h-[92vh] flex flex-col shadow-2xl overflow-hidden text-left">
        ...
        <div className="p-5 overflow-y-auto space-y-4 flex-1">
          ...
          <div className="space-y-2">
            <label className="block text-[11px] font-bold text-[var(--theme-text-dim,#94A3B8)] uppercase tracking-wider">
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="50000"
                className="w-full bg-[var(--theme-bg,#070E18)] border border-[var(--theme-border,#213E61)] focus:border-[var(--theme-primary,#38BDF8)] rounded-xl pl-9 pr-4 py-2.5 text-[18px] font-mono font-bold text-[var(--theme-text,#F8FAFC)] outline-none transition-all shadow-inner"
              />
            </div>
                ...
                <button
                  ...
                  className={`px-2.5 py-1 rounded-lg text-[11px] font-mono font-bold transition-all cursor-pointer border ${
                    numAmount === amt
                      ...
                      : 'bg-[var(--theme-surface,#0E1A29)] text-[var(--theme-text-muted,#CBD5E1)] border-[var(--theme-border,#213E61)] hover:border-white/20'
                  }`}
                >
          ...
          <div className="space-y-2 pt-2 border-t border-[var(--theme-border,#213E61)]">
            <div className="flex items-center justify-between">
              <span className="text-[11px] font-bold text-[var(--theme-text-dim,#94A3B8)] uppercase tracking-wider">
                {t.calculator.calculatedBreakdown}
              </span>
              <span className="text-[11px] text-[#64748B]">
                Total: <span className="font-mono font-bold text-[var(--theme-text,#F8FAFC)]">{formatCurrency(numAmount, privacyMask)}</span>
              </span>
            </div>
        ...
        <div className="p-4 border-t border-[var(--theme-border,#213E61)] bg-[var(--theme-surface,#0E1A29)] flex items-center justify-between gap-3 shrink-0">
          <button
            type="button"
            onClick={onClose}
            className="px-4 py-2 rounded-xl border border-[var(--theme-border,#213E61)] text-[var(--theme-text-dim,#94A3B8)] hover:text-[var(--theme-text,#F8FAFC)] text-[12px] font-bold transition-colors cursor-pointer"
          >
            {t.add.cancel}
          </button>
