      ...
      <div className="bg-[var(--theme-card,#132438)] border border-[var(--theme-border,#213E61)] rounded-2xl w-full max-w-sm p-5 shadow-2xl space-y-4 animate-in zoom-in-95 duration-150 text-left">
        <div className="flex items-start gap-3">
          ...
          <div className="space-y-1">
            <h3 className="font-serif-display text-[16.5px] font-bold text-[var(--theme-text,#F8FAFC)] leading-snug">
              {title}
            </h3>
            {displayMessage && (
        ...
        <div className="grid grid-cols-2 gap-2.5 pt-2 border-t border-[var(--theme-border,#213E61)]">
          <button
            ...
            className="py-2.5 px-3 rounded-xl border border-[var(--theme-border,#213E61)] bg-[var(--theme-surface,#0E1A29)] text-[var(--theme-text-dim,#94A3B8)] hover:text-[var(--theme-text,#F8FAFC)] text-[13px] font-bold cursor-pointer transition-colors"
          >
            {displayCancelLabel}
          </button>
          <button
