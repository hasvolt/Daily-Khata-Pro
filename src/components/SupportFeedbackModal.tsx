...
export const SupportFeedbackModal: React.FC<SupportFeedbackModalProps> = ({
  ...
  const faqs = [
    ...
    {
      id: 'faq-3',
      qEn: 'How does the Smart Fund Rule work?',
      qHi: 'स्मार्ट फंड (6-Jar) वित्तीय नियम कैसे काम करता है?',
  ...
  return (
    ...
    >
      <div
        className="w-full max-w-2xl max-h-[90vh] bg-[var(--theme-surface,#0E1A29)] border border-[var(--theme-border,#213E61)] rounded-2xl shadow-2xl flex flex-col overflow-hidden text-[var(--theme-text,#F8FAFC)]"
        style={{
      ...
      >
        ...
        <div className="p-3.5 sm:p-4 bg-[var(--theme-card,#132438)] border-b border-[var(--theme-border,#213E61)] flex items-center justify-between shrink-0">
          <div className="flex items-center gap-2.5">
            <AppLogo size={32} />
            <div>
              <h2 id="support-modal-title" className="text-base sm:text-lg font-bold text-[var(--theme-text,#F8FAFC)] flex items-center gap-2">
                <span>{isHindi ? 'सहायता एवं सुझाव केंद्र' : 'Help & Support Centre'}</span>
              </h2>
              <p className="text-[11px] sm:text-[11.5px] text-[var(--theme-text-dim,#94A3B8)]">
                {isHindi
          ...
          <div className="flex items-center gap-1.5">
            {onOpenFullPage && (
              <button
                ...
                className="p-2 rounded-xl text-[var(--theme-text-dim,#94A3B8)] hover:text-[var(--theme-primary,#38BDF8)] hover:bg-[var(--theme-surface,#0E1A29)] transition-colors cursor-pointer text-[12px] flex items-center gap-1 font-semibold"
            ...
            <button
              type="button"
              onClick={onClose}
              className="p-2 rounded-xl text-[var(--theme-text-dim,#94A3B8)] hover:text-[var(--theme-text,#F8FAFC)] hover:bg-[var(--theme-surface,#0E1A29)] transition-colors cursor-pointer"
        ...
        {feedbackNotice && (
          <div className="mx-4 mt-3 p-2.5 rounded-xl bg-[var(--theme-primary,#38BDF8)]/15 border border-[var(--theme-primary,#38BDF8)]/40 text-[var(--theme-primary,#38BDF8)] text-[12px] font-medium flex items-center justify-between animate-in fade-in">
            ...
            <button
              ...
              className="text-[var(--theme-text-dim,#94A3B8)] hover:text-white"
            >
        ...
        <div className="flex-1 overflow-y-auto p-4 sm:p-5 space-y-4">
          ...
          {activeTab === 'help' && (
            <div className="space-y-4 animate-in fade-in duration-150">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                {onOpenManual && (
                  ...
                  >
                    ...
                    <div>
                      <div className="text-[12.5px] font-bold text-[var(--theme-text,#F8FAFC)] group-hover:text-[var(--theme-primary,#38BDF8)]">
                        {isHindi ? 'विस्तृत यूजर मैनुअल' : 'Interactive User Manual'}
                      </div>
                      <div className="text-[11px] text-[var(--theme-text-dim,#94A3B8)]">
                        {isHindi ? 'सभी सुविधाओं और स्मार्ट फंड नियमों की पूरी गाइड' : 'Step-by-step documentation & rules'}
                      </div>
                    </div>
                  </button>
                )}
              ...
              <div className="p-3 rounded-xl bg-[var(--theme-card,#132438)]/60 border border-[var(--theme-border,#213E61)] space-y-2">
                <div className="text-[11.5px] font-bold text-[var(--theme-text-muted,#CBD5E1)] flex items-center justify-between">
                  <span>{isHindi ? 'आधिकारिक सपोर्ट चैनल' : 'Official Support Channel'}</span>
                  <span className="text-[10px] text-[var(--theme-text-dim,#94A3B8)]">Response within 24h</span>
                </div>
                <div className="flex flex-wrap gap-2">
                  <a
                    href={`mailto:${officialEmail}?subject=Daily%20Khata%20Pro%20Support%20Request`}
                    className="flex-1 min-w-[200px] px-3 py-2 rounded-lg bg-[var(--theme-surface,#0E1A29)] border border-[var(--theme-border,#213E61)] hover:border-[var(--theme-primary,#38BDF8)] text-[12px] text-[var(--theme-text-muted,#CBD5E1)] hover:text-[var(--theme-text,#F8FAFC)] flex items-center justify-between transition-colors font-mono"
                  >
                    <div className="flex items-center gap-2">
                  ...
                  <a
                    ...
                    className="px-3 py-2 rounded-lg bg-[var(--theme-surface,#0E1A29)] border border-[var(--theme-border,#213E61)] hover:border-[var(--theme-primary,#38BDF8)] text-[12px] text-[var(--theme-text-muted,#CBD5E1)] hover:text-[var(--theme-primary,#38BDF8)] flex items-center gap-1.5 transition-colors font-semibold"
                  >
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between gap-2">
                  <span className="text-[12px] font-bold text-[var(--theme-text,#F8FAFC)]">
                  ...
                  <input
                    ...
                    className="px-2.5 py-1 rounded-lg bg-[var(--theme-card,#132438)] border border-[var(--theme-border,#213E61)] text-[11px] text-[var(--theme-text,#F8FAFC)] placeholder-[#64748B] focus:outline-none focus:border-[var(--theme-primary,#38BDF8)] w-36 sm:w-48"
                  />
                </div>
                  ...
                  {filteredFaqs.map((faq) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {isOpen && (
                          <div className="px-3 pb-3 pt-1 text-[11.5px] leading-relaxed text-[var(--theme-text-dim,#94A3B8)] border-t border-[var(--theme-border,#213E61)]/50">
          ...
          {activeTab === 'bug' && (
            <div className="space-y-3.5 animate-in fade-in duration-150">
              ...
              {/* Bug Title */}
              <div>
                <label className="block text-[11.5px] font-bold text-[var(--theme-text-muted,#CBD5E1)] mb-1">
                ...
                <input
                  ...
                  className="w-full px-3 py-2 rounded-xl bg-[var(--theme-card,#132438)] border border-[var(--theme-border,#213E61)] text-[12px] text-[var(--theme-text,#F8FAFC)] placeholder-[#64748B] focus:outline-none focus:border-[#EF4444]"
                />
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-3 py-2 rounded-xl bg-[var(--theme-card,#132438)] border border-[var(--theme-border,#213E61)] text-[12px] text-[var(--theme-text,#F8FAFC)] focus:outline-none focus:border-[#EF4444]"
                  >
                ...
                <div>
                  ...
                  <div className="px-3 py-2 rounded-xl bg-[var(--theme-card,#132438)]/50 border border-[var(--theme-border,#213E61)] text-[11px] text-[var(--theme-text-dim,#94A3B8)] font-mono truncate">
                    {getSystemInfo()}
                  </div>
                </div>
              </div>
              ...
              <div className="pt-2 flex flex-wrap items-center gap-2">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="px-3.5 py-2 rounded-xl bg-[var(--theme-card,#132438)] border border-[var(--theme-border,#213E61)] hover:border-[#F8FAFC]/40 text-[var(--theme-text-muted,#CBD5E1)] hover:text-[var(--theme-text,#F8FAFC)] font-semibold text-[12px] flex items-center gap-1.5 transition-colors cursor-pointer"
                >
                ...
                <button
                  ...
                  className="px-3 py-2 rounded-xl bg-[var(--theme-surface,#0E1A29)] border border-[var(--theme-border,#213E61)] hover:border-[var(--theme-primary,#38BDF8)] text-[var(--theme-text-dim,#94A3B8)] hover:text-[var(--theme-text,#F8FAFC)] font-medium text-[12px] flex items-center gap-1.5 transition-colors cursor-pointer ml-auto"
            ...
            <div className="space-y-3.5 animate-in fade-in duration-150">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 rounded-xl bg-[var(--theme-card,#132438)] border border-[var(--theme-border,#213E61)] text-[12px] text-[var(--theme-text,#F8FAFC)] placeholder-[#64748B] focus:outline-none focus:border-[#F59E0B]"
                />
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-3 py-2 rounded-xl bg-[var(--theme-card,#132438)] border border-[var(--theme-border,#213E61)] text-[12px] text-[var(--theme-text,#F8FAFC)] focus:outline-none focus:border-[#F59E0B]"
                >
        ...
        {/* Modal Footer */}
        <div className="p-3 bg-[var(--theme-card,#132438)] border-t border-[var(--theme-border,#213E61)] flex items-center justify-between text-[11px] text-[var(--theme-text-dim,#94A3B8)] shrink-0">
          <div className="flex items-center gap-2">
          ...
          <button
            type="button"
            onClick={onClose}
            className="px-3 py-1 rounded-lg bg-[var(--theme-surface,#0E1A29)] hover:bg-[var(--theme-card-hover,#19304A)] border border-[var(--theme-border,#213E61)] text-[var(--theme-text-muted,#CBD5E1)] hover:text-[var(--theme-text,#F8FAFC)] font-semibold transition-colors cursor-pointer"
          >
