...
export const GuidePage: React.FC<GuidePageProps> = ({
  ...
  return (
    <div className="w-full max-w-6xl mx-auto space-y-6 animate-in fade-in duration-300 text-left pb-12">
      ...
      {/* Main Container */}
      <div className="bg-[var(--theme-surface,#0E1A29)] border border-[var(--theme-border,#213E61)] rounded-2xl shadow-xl overflow-hidden flex flex-col md:flex-row min-h-[700px]">
        {/* Navigation Sidebar */}
          ...
          <div className="p-4 border-b border-[var(--theme-border,#213E61)]">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-9 pr-3 py-2 text-[13px] rounded-xl bg-[var(--theme-surface,#0E1A29)] border border-[var(--theme-border,#213E61)] text-[#F8FAFC] placeholder-[#64748B] focus:outline-none focus:border-[var(--theme-primary,#38BDF8)]"
              />
            </div>
          </div>
              ...
              return (
                <button
                  ...
                  className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-left transition-all cursor-pointer ${
                    isActive
                      ? 'bg-[var(--theme-card,#132438)] border border-[var(--theme-primary,#38BDF8)] text-[var(--theme-primary,#38BDF8)] font-bold shadow-sm'
        ...
        <div className="flex-1 p-6 sm:p-8 space-y-6 overflow-y-auto custom-scrollbar">
          {currentSection && (
            <div className="space-y-6 animate-in fade-in duration-200">
              {/* Section Header */}
              <div className="border-b border-[var(--theme-border,#213E61)] pb-4">
                ...
                <h2 className="font-serif-display text-[24px] font-bold text-[#F8FAFC]">
              ...
              {currentSection.overviewText && (
                <div className="bg-[var(--theme-card,#132438)] border border-[var(--theme-border,#213E61)] rounded-2xl p-5 sm:p-6 space-y-2.5 shadow-sm">
              ...
              {currentSection.features && currentSection.features.length > 0 && (
                <div className="p-5 sm:p-6 rounded-2xl bg-[var(--theme-bg,#070E18)] border border-[var(--theme-border,#213E61)] space-y-3">
                  <div className="text-[14px] font-bold text-[#F8FAFC] flex items-center gap-2">
                ...
                <div className="space-y-3">
                  ...
                  <div className="space-y-3">
                    {currentSection.faqList.map((item, idx) => (
                      ...
                      >
                        <div className="font-bold text-[14px] text-[#F8FAFC] flex items-start gap-2">
              ...
              {currentSection.proTip && (
                <div className="p-4 sm:p-5 rounded-2xl bg-amber-500/10 border border-amber-500/30 flex items-start gap-3.5 text-amber-300">
              ...
              {currentSection.id === 'app_lock' && onOpenSecurityLock && (
                <button
                  ...
                  className="w-full py-3 px-4 rounded-xl bg-[#10B981]/15 border border-[#10B981]/40 text-[#F8FAFC] hover:border-[#10B981] font-bold text-[13.5px] flex items-center justify-center gap-2 transition-all cursor-pointer shadow-sm"
                >
              ...
              {currentSection.id === 'source_code' && onOpenSourceCode && (
                <button
                  ...
                  className="w-full py-3 px-4 rounded-xl bg-[var(--theme-primary,#38BDF8)]/15 border border-[var(--theme-primary,#38BDF8)]/40 text-[#F8FAFC] hover:border-[var(--theme-primary,#38BDF8)] font-bold text-[13.5px] flex items-center justify-center gap-2 transition-all cursor-pointer shadow-sm"
                >
