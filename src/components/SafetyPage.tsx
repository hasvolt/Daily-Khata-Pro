...
const STORAGE_KEY = 'daily_khata_pro_v3';
    ...
    <div className="w-full max-w-6xl mx-auto space-y-6 animate-in fade-in duration-300 text-left pb-12">
      ...
      <div className="bg-[var(--theme-surface,#0E1A29)] border border-[var(--theme-border,#213E61)] rounded-2xl p-5 sm:p-6 shadow-md flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          <button
            onClick={onBack}
            className="w-10 h-10 rounded-xl bg-[var(--theme-bg,#070E18)] border border-[var(--theme-border,#213E61)] flex items-center justify-center text-[var(--theme-text-dim,#94A3B8)] hover:text-[var(--theme-text,#F8FAFC)] transition-colors cursor-pointer shrink-0 shadow-sm"
          >
            <ArrowLeft className="w-5 h-5" />
          </button>
          <div>
            <div className="flex flex-wrap items-center gap-2">
              <h1 className="font-serif-display text-[22px] sm:text-[26px] font-bold text-[var(--theme-text,#F8FAFC)]">
                {tr.safety.title}
              </h1>
        ...
        <div className="flex items-center gap-2 self-end md:self-auto">
          <button
            onClick={onBack}
            className="px-4 py-2 rounded-xl bg-[var(--theme-card,#132438)] border border-[var(--theme-border,#213E61)] text-[var(--theme-text,#F8FAFC)] text-[13px] font-bold hover:bg-[var(--theme-card-hover,#19304A)] transition-all cursor-pointer shadow-sm"
          >
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div className="p-6 rounded-2xl bg-[var(--theme-bg,#070E18)] border border-[var(--theme-primary,#38BDF8)]/30 shadow-lg space-y-4">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="font-serif-display text-[20px] font-bold text-[var(--theme-text,#F8FAFC)]">
                        {tr.safety.repoTitle}
                      </h3>
                      <p className="text-[13px] text-[var(--theme-text-dim,#94A3B8)] mt-1">
                        {tr.safety.repoDesc}
                      </p>
                    </div>
                  </div>
                ...
                <div className="p-6 rounded-2xl bg-[var(--theme-bg,#070E18)] border border-[var(--theme-border,#213E61)] space-y-4 shadow-lg">
                  <div className="flex items-center justify-between text-[11px] text-[var(--theme-text-dim,#94A3B8)] uppercase tracking-wider font-bold">
                  ...
                  <div className="flex items-center justify-between gap-3 p-3 rounded-xl bg-[var(--theme-surface,#0E1A29)] border border-[var(--theme-border,#213E61)] font-mono text-[13px] group">
                    ...
                    <button
                      ...
                      className="p-2 rounded-lg bg-[var(--theme-card,#132438)] border border-[var(--theme-border,#213E61)] hover:bg-[var(--theme-card-hover,#19304A)] text-[var(--theme-text,#F8FAFC)] transition-all cursor-pointer shrink-0"
                    >
                      {copiedClone ? <Check className="w-4 h-4 text-[var(--theme-primary,#38BDF8)]" /> : <Copy className="w-4 h-4 text-[var(--theme-text-dim,#94A3B8)]" />}
                    </button>
                  </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                {[
                  ...
                  >
                    ...
                    <h5 className="font-bold text-[var(--theme-text,#F8FAFC)] text-[15px]">{item.title}</h5>
                    <p className="text-[12.5px] text-[var(--theme-text-dim,#94A3B8)]">{item.desc}</p>
                  </div>
                ))}
              </div>
            </div>
                  ...
                  <button
                    ...
                    className={`w-full flex items-start gap-3 p-3 rounded-xl text-left transition-all cursor-pointer ${
                      selectedFileIndex === idx
                        ...
                        : 'text-[var(--theme-text-dim,#94A3B8)] hover:bg-[var(--theme-surface,#0E1A29)] hover:text-[var(--theme-text,#F8FAFC)]'
                    }`}
                  >
              ...
              <div className="flex-1 flex flex-col bg-[var(--theme-surface,#0E1A29)]">
                <div className="px-5 py-3 border-b border-[var(--theme-border,#213E61)] flex items-center justify-between shrink-0">
                  ...
                  <button
                    ...
                    className="px-3 py-1.5 rounded-lg bg-[var(--theme-card,#132438)] border border-[var(--theme-border,#213E61)] text-[12px] font-bold text-[var(--theme-text,#F8FAFC)] flex items-center gap-2 hover:bg-[var(--theme-card-hover,#19304A)] transition-all cursor-pointer"
                  >
                ...
                <div className="flex-1 p-5 overflow-auto bg-[var(--theme-bg,#070E18)] font-mono text-[12.5px] leading-relaxed text-[var(--theme-text-muted,#CBD5E1)] custom-scrollbar">
            ...
            <div className="p-6 sm:p-8 space-y-6 animate-in fade-in">
              <div className="p-6 rounded-2xl bg-[var(--theme-surface,#0E1A29)] border border-[var(--theme-primary,#38BDF8)]/30 flex items-start gap-5">
                ...
                <div>
                  ...
                  <p className="text-[14px] text-[var(--theme-text-dim,#94A3B8)] mt-1 leading-relaxed">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {[
                  ...
                  >
                    ...
                    <div>
                      <h5 className="font-bold text-[var(--theme-text,#F8FAFC)] text-[15px]">{item.title}</h5>
                      <p className="text-[13px] text-[var(--theme-text-dim,#94A3B8)] mt-0.5">{item.desc}</p>
                    </div>
                  </div>
                ))}
              </div>
          ...
          {activeTab === 'verify' && (
            <div className="p-6 sm:p-8 space-y-6 animate-in fade-in">
              <div className="space-y-4">
                <h3 className="text-[20px] font-bold text-[var(--theme-text,#F8FAFC)]">
                  {tr.safety.verifyTitle}
                </h3>
                <p className="text-[14px] text-[var(--theme-text-dim,#94A3B8)]">
              ...
              <div className="space-y-4">
                {[
                  ...
                  >
                    ...
                    <div>
                      <h5 className="font-bold text-[var(--theme-text,#F8FAFC)] text-[16px]">{item.title}</h5>
                      <p className="text-[14px] text-[var(--theme-text-dim,#94A3B8)] mt-1">{item.desc}</p>
                    </div>
                  </div>
                ))}
              </div>
