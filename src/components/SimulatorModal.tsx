      ...
      <div className="bg-[var(--theme-card,#132438)] border border-[var(--theme-border,#213E61)] rounded-2xl w-full max-w-2xl max-h-[92vh] flex flex-col shadow-2xl overflow-hidden animate-in zoom-in-95 duration-150">
        ...
        <div className="flex items-center justify-between p-4 sm:p-5 border-b border-[var(--theme-border,#213E61)] bg-[var(--theme-surface,#0E1A29)]/90">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="font-serif-display text-[17px] sm:text-[19px] font-bold text-[var(--theme-text,#F8FAFC)]">
                {t.simulator.title}
              </h2>
              <p className="text-[11.5px] sm:text-[12px] text-[var(--theme-text-dim,#94A3B8)]">
        ...
        <div className="p-4 sm:p-6 overflow-y-auto space-y-6 flex-1">
          ...
          <div className="bg-[var(--theme-bg,#070E18)] border border-[var(--theme-border,#213E61)] rounded-2xl p-4 sm:p-5 space-y-3.5">
            <label className="block text-[12.5px] font-bold uppercase tracking-wider text-[var(--theme-text-dim,#94A3B8)]">
              {t.simulator.enterIncome}
            </label>

            <div className="relative">
              <span className="absolute left-4 top-1/2 -translate-y-1/2 text-2xl font-bold text-[var(--theme-text-dim,#94A3B8)]">{getCurrencyConfig(getCurrentLanguage()).symbol}</span>
              <input
                ...
                placeholder="50000"
                className="w-full bg-[var(--theme-surface,#0E1A29)] border border-[var(--theme-border,#213E61)] focus:border-[var(--theme-primary,#38BDF8)] text-[var(--theme-text,#F8FAFC)] text-2xl sm:text-3xl font-bold pl-10 pr-4 py-3 rounded-xl outline-none num transition-all shadow-inner"
              />
            </div>
                  ...
                  <button
                    ...
                    className={`px-3 py-1.5 rounded-lg text-[12px] font-bold transition-all cursor-pointer ${
                      simAmount === amt
                        ...
                        : 'bg-[var(--theme-surface,#0E1A29)] border border-[var(--theme-border,#213E61)] text-[var(--theme-text-muted,#CBD5E1)] hover:border-[var(--theme-primary,#38BDF8)]'
                    }`}
                  >
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              <div className="text-[13px] font-extrabold uppercase tracking-wider text-[var(--theme-text-muted,#CBD5E1)] flex items-center gap-1.5">
              ...
              <button
                ...
                className="text-[11px] text-[var(--theme-text-dim,#94A3B8)] hover:text-[var(--theme-primary,#38BDF8)] flex items-center gap-1 transition-colors cursor-pointer"
              >
                ...
                return (
                  ...
                  >
                    ...
                    <div className="pt-2 flex items-baseline justify-between">
                      ...
                      <span
                        className="text-[16px] sm:text-[17px] font-bold num text-[var(--theme-text,#F8FAFC)]"
        ...
        <div className="p-4 sm:p-5 border-t border-[var(--theme-border,#213E61)] bg-[var(--theme-surface,#0E1A29)]/90 flex flex-col sm:flex-row items-center justify-between gap-3">
          <div className="text-[12px] text-[var(--theme-text-dim,#94A3B8)] flex items-center gap-1.5">
          ...
          <div className="flex items-center gap-2.5 w-full sm:w-auto">
            <button
              type="button"
              onClick={onClose}
              className="flex-1 sm:flex-initial px-4 py-2.5 rounded-xl border border-[var(--theme-border,#213E61)] text-[var(--theme-text-muted,#CBD5E1)] hover:bg-[var(--theme-card,#132438)] text-[13px] font-bold transition-all cursor-pointer"
            >
              {t.add.cancel}
            </button>
            <button
