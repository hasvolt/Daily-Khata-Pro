...
export const STORAGE_KEY = 'daily_khata_pro_v3';
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-black/85 backdrop-blur-sm animate-in fade-in duration-150 no-print">
      <div className="bg-[var(--theme-surface,#0E1A29)] border border-[var(--theme-border,#213E61)] rounded-2xl w-full max-w-4xl max-h-[92vh] flex flex-col shadow-2xl overflow-hidden text-left">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h2 className="font-serif-display text-[17px] font-bold text-[var(--theme-text,#F8FAFC)]">
                  {tr.safety.title}
                </h2>
          ...
          <button
            ...
            className={`py-2.5 px-3 text-[12px] font-bold flex items-center gap-1.5 border-b-2 transition-all cursor-pointer whitespace-nowrap ${
              activeTab === 'github'
                ...
                : 'border-transparent text-[var(--theme-text-dim,#94A3B8)] hover:text-[var(--theme-text,#F8FAFC)]'
            }`}
          >
          ...
          <div className="flex-1 p-5 sm:p-6 overflow-y-auto space-y-5 bg-[var(--theme-bg,#070E18)]">
            ...
            <div className="p-5 rounded-2xl bg-[var(--theme-surface,#0E1A29)] border border-[var(--theme-primary,#38BDF8)]/40 shadow-xl space-y-4">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div className="flex items-start gap-3.5">
                  ...
                  <div>
                    <div className="flex items-center gap-2">
                      <h3 className="font-serif-display text-[18px] font-bold text-[var(--theme-text,#F8FAFC)]">
                        GitHub / Daily-Khata-Pro
                      </h3>
                    ...
                    <p className="text-[12.5px] text-[var(--theme-text-dim,#94A3B8)] mt-0.5">
                ...
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="px-3.5 py-2 rounded-xl bg-[var(--theme-card,#132438)] hover:bg-[var(--theme-card-hover,#19304A)] border border-[var(--theme-border,#213E61)] text-[var(--theme-text,#F8FAFC)] font-bold text-[12px] flex items-center gap-1.5 transition-all shadow-xs"
                  >
              ...
              <div className="p-3.5 rounded-xl bg-[var(--theme-card,#132438)] border border-[var(--theme-border,#213E61)] space-y-2">
                <div className="flex items-center justify-between text-[11px] text-[var(--theme-text-dim,#94A3B8)]">
                  <span className="font-bold flex items-center gap-1.5 text-[var(--theme-text-muted,#CBD5E1)]">
                ...
                <div className="flex items-center justify-between gap-2 p-2 rounded-lg bg-[var(--theme-surface,#0E1A29)] border border-[var(--theme-border,#213E61)] font-mono text-[12px]">
                  ...
                  <button
                    ...
                    className="px-2.5 py-1 rounded bg-[var(--theme-card,#132438)] hover:bg-[var(--theme-card-hover,#19304A)] border border-[var(--theme-border,#213E61)] text-[var(--theme-text,#F8FAFC)] text-[11px] font-bold flex items-center gap-1 transition-all cursor-pointer shrink-0"
                  >
                    {copiedClone ? (
                      <>
                      ...
                      <>
                        <Copy className="w-3.5 h-3.5 text-[var(--theme-text-dim,#94A3B8)]" />
            ...
            <div className="p-4 rounded-2xl bg-[var(--theme-surface,#0E1A29)] border border-[var(--theme-border,#213E61)] space-y-3">
              <div className="flex items-center justify-between">
                <h4 className="font-bold text-[14px] text-[#0F172A] dark:text-[var(--theme-text,#F8FAFC)] flex items-center gap-2">
              ...
              <div className="p-3 rounded-xl bg-[var(--theme-card,#132438)] border border-[var(--theme-border,#213E61)] font-mono text-[11.5px] text-[#0F172A] dark:text-[var(--theme-text-muted,#CBD5E1)] space-y-1.5 shadow-inner">
                <p className="text-[#64748B] dark:text-[var(--theme-text-dim,#94A3B8)]"># 1. Clone repository from GitHub</p>
                <p className="text-[var(--theme-primary,#38BDF8)] font-bold">git clone {GITHUB_CLONE_URL}</p>
                <p className="text-[#64748B] dark:text-[var(--theme-text-dim,#94A3B8)] pt-1"># 2. Enter project folder</p>
                <p className="text-[#0F172A] dark:text-[var(--theme-text,#F8FAFC)] font-semibold">cd Daily-Khata-Pro</p>
                <p className="text-[#64748B] dark:text-[var(--theme-text-dim,#94A3B8)] pt-1"># 3. Install packages</p>
                <p className="text-[#0F172A] dark:text-[var(--theme-text,#F8FAFC)] font-semibold">npm install</p>
                <p className="text-[#64748B] dark:text-[var(--theme-text-dim,#94A3B8)] pt-1"># 4. Launch local dev server</p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              <div className="p-3.5 rounded-xl bg-[var(--theme-surface,#0E1A29)] border border-[var(--theme-border,#213E61)] space-y-1">
                <div className="text-[10px] uppercase font-bold text-[#64748B] dark:text-[var(--theme-text-dim,#94A3B8)]">Open License</div>
                <div className="font-bold text-[13px] text-[#0F172A] dark:text-[var(--theme-text,#F8FAFC)]">{tr.safety.mitLicenseTitle}</div>
                <p className="text-[11px] text-[#64748B] dark:text-[var(--theme-text-dim,#94A3B8)]">{tr.safety.mitLicenseDesc}</p>
              </div>

              <div className="p-3.5 rounded-xl bg-[var(--theme-surface,#0E1A29)] border border-[var(--theme-border,#213E61)] space-y-1">
                <div className="text-[10px] uppercase font-bold text-[#64748B] dark:text-[var(--theme-text-dim,#94A3B8)]">Modern Stack</div>
                <div className="font-bold text-[13px] text-[#0F172A] dark:text-[var(--theme-text,#F8FAFC)]">{tr.safety.modernStackTitle}</div>
                <p className="text-[11px] text-[#64748B] dark:text-[var(--theme-text-dim,#94A3B8)]">{tr.safety.modernStackDesc}</p>
              </div>

              <div className="p-3.5 rounded-xl bg-[var(--theme-surface,#0E1A29)] border border-[var(--theme-border,#213E61)] space-y-1">
                <div className="text-[10px] uppercase font-bold text-[#64748B] dark:text-[var(--theme-text-dim,#94A3B8)]">Privacy Standard</div>
                <div className="font-bold text-[13px] text-[#059669] dark:text-[#10B981]">{tr.safety.auditReadyTitle}</div>
                <p className="text-[11px] text-[#64748B] dark:text-[var(--theme-text-dim,#94A3B8)]">{tr.safety.auditReadyDesc}</p>
              </div>
            </div>
          </div>
        )}
        ...
        {activeTab === 'inspector' && (
          <div className="flex-1 flex flex-col md:flex-row overflow-hidden min-h-[420px]">
            ...
            <div className="w-full md:w-64 border-b md:border-b-0 md:border-r border-[var(--theme-border,#213E61)] bg-[var(--theme-bg,#070E18)] p-3 flex flex-col gap-2 shrink-0">
              <div className="text-[10.5px] uppercase tracking-wider font-extrabold text-[#64748B] dark:text-[var(--theme-text-dim,#94A3B8)] px-2 pt-1">
                Core Source Modules
              </div>
                    ...
                    <button
                      ...
                      className={`w-full flex items-start gap-2.5 p-2.5 rounded-xl text-left transition-all cursor-pointer ${
                        isSelected
                          ...
                          : 'border border-transparent text-[#64748B] dark:text-[var(--theme-text-dim,#94A3B8)] hover:text-[#0F172A] dark:hover:text-[var(--theme-text,#F8FAFC)] hover:bg-[var(--theme-surface,#0E1A29)]'
                      }`}
                    >
                      <Icon
                      ...
                      <div className="min-w-0 flex-1">
                        <div className="font-mono text-[12px] font-bold truncate text-[#0F172A] dark:text-[var(--theme-text,#F8FAFC)]">
                          {file.name}
                        </div>
                        <div className="text-[10px] text-[#64748B] dark:text-[var(--theme-text-dim,#94A3B8)] truncate">
                          {file.category}
                        </div>
                      </div>
                    </button>
              ...
              <div className="p-3 bg-[var(--theme-surface,#0E1A29)] border border-[var(--theme-border,#213E61)] rounded-xl text-[11px] space-y-1.5 mt-auto hidden md:block">
                <div className="text-[#64748B] dark:text-[var(--theme-text-dim,#94A3B8)] font-bold text-[10px] uppercase">Device Storage Info</div>
                <div className="flex justify-between text-[#334155] dark:text-[var(--theme-text-muted,#CBD5E1)]">
                  <span>Storage Key:</span>
                  <span className="font-mono text-[var(--theme-primary,#38BDF8)] font-bold">daily_khata_pro_v3</span>
                </div>
                <div className="flex justify-between text-[#334155] dark:text-[var(--theme-text-muted,#CBD5E1)]">
              ...
              <div className="px-4 py-2.5 border-b border-[var(--theme-border,#213E61)] bg-[var(--theme-surface,#0E1A29)] flex items-center justify-between gap-3 shrink-0">
                <div className="min-w-0">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[9.5px] uppercase font-mono px-2 py-0.5 rounded bg-[var(--theme-card,#132438)] border border-[var(--theme-border,#213E61)] text-[#0F172A] dark:text-[var(--theme-text-muted,#CBD5E1)] font-bold">
                      {currentFile.language}
                    </span>
                  </div>
                  <p className="text-[11px] text-[#64748B] dark:text-[var(--theme-text-dim,#94A3B8)] truncate">{currentFile.description}</p>
                </div>

                <div className="flex items-center gap-2 shrink-0">
                  <button
                    onClick={handleCopyCode}
                    className="px-2.5 py-1.5 rounded-lg bg-[var(--theme-card,#132438)] hover:bg-[var(--theme-card-hover,#19304A)] border border-[var(--theme-border,#213E61)] text-[#0F172A] dark:text-[var(--theme-text,#F8FAFC)] text-[11.5px] font-semibold flex items-center gap-1.5 transition-all cursor-pointer active:scale-95"
                  ...
                  >
                    {copied ? (
                      ...
                      <>
                        <Copy className="w-3.5 h-3.5 text-[#64748B] dark:text-[var(--theme-text-dim,#94A3B8)]" />
                        <span>Copy Code</span>
                      </>
                    )}
                  </button>
          ...
          <div className="flex-1 p-5 sm:p-6 overflow-y-auto space-y-5 bg-[var(--theme-bg,#070E18)]">
            ...
            <div className="p-4 rounded-2xl bg-[var(--theme-surface,#0E1A29)] border border-[var(--theme-border,#213E61)] flex items-start gap-3.5">
              ...
              <div className="space-y-1">
                <h3 className="font-serif-display text-[16px] font-bold text-[var(--theme-text,#F8FAFC)]">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              <div className="p-3.5 rounded-xl bg-[var(--theme-surface,#0E1A29)] border border-[var(--theme-border,#213E61)] space-y-1.5">
                ...
                <p className="text-[11.5px] text-[var(--theme-text-dim,#94A3B8)] leading-relaxed">
                  All record records live securely in your browser&apos;s sandboxed storage (<code className="text-[var(--theme-primary,#38BDF8)]">daily_khata_pro_v3</code>). Other websites cannot access it.
                </p>
              </div>
            ...
            <div className="p-4 rounded-xl bg-[var(--theme-surface,#0E1A29)] border border-[var(--theme-border,#213E61)] space-y-3">
              <div className="text-[12px] font-bold text-[var(--theme-text,#F8FAFC)] uppercase tracking-wider">
                Architecture Comparison
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-[12px]">
                <div className="p-3 rounded-lg bg-[#EF4444]/10 border border-[#EF4444]/20 space-y-1 text-[#EF4444]">
                  ...
                  <p className="text-[11px] text-[#64748B] dark:text-[var(--theme-text-muted,#CBD5E1)] leading-relaxed">
        ...
        {/* Tab 3: How to Verify */}
        {activeTab === 'verify' && (
          <div className="flex-1 p-5 sm:p-6 overflow-y-auto space-y-4 bg-[var(--theme-bg,#070E18)] text-[var(--theme-text,#F8FAFC)] text-[13px]">
            <div className="space-y-1">
              <h3 className="font-serif-display text-[16px] font-bold text-[var(--theme-text,#F8FAFC)]">
            ...
            <div className="space-y-3">
              <div className="p-3.5 rounded-xl bg-[var(--theme-surface,#0E1A29)] border border-[var(--theme-border,#213E61)] flex items-start gap-3">
                ...
                <div className="space-y-1">
                  <div className="font-bold text-[var(--theme-text,#F8FAFC)]">{tr.safety.step1Title}</div>
                  <p className="text-[12px] text-[var(--theme-text-dim,#94A3B8)]">
                    {tr.safety.step1Desc}
                  </p>
                </div>
              ...
              <div className="p-3.5 rounded-xl bg-[var(--theme-surface,#0E1A29)] border border-[var(--theme-border,#213E61)] flex items-start gap-3">
                ...
                <div className="space-y-1">
                  <div className="font-bold text-[var(--theme-text,#F8FAFC)]">{tr.safety.step2Title}</div>
                  <p className="text-[12px] text-[var(--theme-text-dim,#94A3B8)]">
                    {tr.safety.step2Desc}
                  </p>
                </div>
              ...
              <div className="p-3.5 rounded-xl bg-[var(--theme-surface,#0E1A29)] border border-[var(--theme-border,#213E61)] flex items-start gap-3">
                ...
                <div className="space-y-1">
                  <div className="font-bold text-[var(--theme-text,#F8FAFC)]">{tr.safety.step3Title}</div>
                  <p className="text-[12px] text-[var(--theme-text-dim,#94A3B8)]">
                    {tr.safety.step3Desc}
                  </p>
                </div>
        ...
        <div className="px-5 py-3.5 border-t border-[var(--theme-border,#213E61)] bg-[var(--theme-surface,#0E1A29)] flex flex-wrap items-center justify-between gap-3 shrink-0">
          <div className="flex items-center gap-2 text-[11.5px] text-[var(--theme-text-dim,#94A3B8)]">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="px-3.5 py-2 rounded-xl bg-[var(--theme-card,#132438)] hover:bg-[var(--theme-card-hover,#19304A)] border border-[var(--theme-border,#213E61)] text-[var(--theme-text,#F8FAFC)] hover:text-[var(--theme-primary,#38BDF8)] font-bold text-[12px] flex items-center gap-1.5 cursor-pointer shadow-xs transition-all"
            >
