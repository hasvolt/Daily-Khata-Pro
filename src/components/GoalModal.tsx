        ...
        <form onSubmit={handleSubmit} className="p-4 sm:p-5 overflow-y-auto space-y-4 text-left">
          ...
          {!editingGoal && (
            <div className="space-y-1.5 bg-[var(--theme-bg,#070E18)] p-3 rounded-xl border border-[var(--theme-border,#213E61)]">
              <div className="flex items-center justify-between text-[11px] font-bold text-[var(--theme-text-dim,#94A3B8)] uppercase tracking-wider">
                ...
                {GOAL_PRESETS.map((p) => {
                  ...
                  return (
                    <button
                      ...
                      className="px-2.5 py-1.5 rounded-lg bg-[var(--theme-surface,#0E1A29)] border border-[var(--theme-border,#213E61)] hover:border-[var(--theme-primary,#38BDF8)]/50 text-[11.5px] font-medium text-[var(--theme-text-dim,#94A3B8)] hover:text-[var(--theme-text,#F8FAFC)] flex items-center gap-1.5 whitespace-nowrap shrink-0 transition-all cursor-pointer"
                    >
          ...
          <div className="space-y-1.5">
            <label className="text-[11px] font-bold text-[var(--theme-text-dim,#94A3B8)] uppercase tracking-wider">
            ...
            <input
              ...
              className="w-full bg-[var(--theme-bg,#070E18)] border border-[var(--theme-border,#213E61)] focus:border-[var(--theme-primary,#38BDF8)] text-[var(--theme-text,#F8FAFC)] rounded-xl px-3.5 py-2.5 text-[14px] focus:outline-none"
            />
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <span className="absolute left-3 top-1/2 -translate-y-1/2 text-[15px] font-bold text-[var(--theme-text-dim,#94A3B8)]">{getCurrencyConfig(getCurrentLanguage()).symbol}</span>
                <input
                  type="number"
                  required
                  step="any"
                  ...
                  className="w-full bg-[var(--theme-bg,#070E18)] border border-[var(--theme-border,#213E61)] focus:border-[var(--theme-primary,#38BDF8)] text-[var(--theme-text,#F8FAFC)] rounded-xl pl-8 pr-3.5 py-2.5 text-[14px] font-mono font-bold focus:outline-none"
                />
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div className="space-y-1.5">
              ...
              <input
                ...
                className="w-full bg-[var(--theme-bg,#070E18)] border border-[var(--theme-border,#213E61)] focus:border-[var(--theme-primary,#38BDF8)] text-[var(--theme-text,#F8FAFC)] rounded-xl px-3.5 py-2.5 text-[13.5px] focus:outline-none"
              />
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <select
                ...
                className="w-full bg-[var(--theme-bg,#070E18)] border border-[var(--theme-border,#213E61)] focus:border-[var(--theme-primary,#38BDF8)] text-[var(--theme-text,#F8FAFC)] rounded-xl px-3.5 py-2.5 text-[13.5px] cursor-pointer focus:outline-none"
              >
          ...
          <div className="pt-2 border-t border-[var(--theme-border,#213E61)] flex items-center justify-end gap-2.5">
            <button
              type="button"
              onClick={onClose}
              className="px-4 py-2.5 rounded-xl border border-[var(--theme-border,#213E61)] bg-transparent text-[var(--theme-text-dim,#94A3B8)] hover:text-[var(--theme-text,#F8FAFC)] font-semibold text-[13px] cursor-pointer"
            >
              Cancel
            </button>
            <button
