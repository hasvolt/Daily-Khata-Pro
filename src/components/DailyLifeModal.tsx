    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-[#030712]/80 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="bg-[var(--theme-card,#132438)] border border-[var(--theme-border,#213E61)] rounded-2xl w-full max-w-xl max-h-[92vh] flex flex-col shadow-2xl overflow-hidden text-left">
        ...
        <form onSubmit={handleSubmit} className="p-5 overflow-y-auto space-y-4 text-[13px] flex-1">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div className="space-y-1.5">
              ...
              <input
                ...
                className="w-full bg-[var(--theme-bg,#070E18)] border border-[var(--theme-border,#213E61)] rounded-xl px-3.5 py-2 text-[13px] text-[var(--theme-text,#F8FAFC)] font-mono focus:outline-none focus:border-[var(--theme-secondary,#FFC700)]"
              />
            </div>

            <div className="space-y-1.5">
              <label className="font-bold uppercase tracking-wider text-[11.5px] text-[var(--theme-text-dim,#94A3B8)]">
              ...
              <input
                ...
                className="w-full bg-[var(--theme-bg,#070E18)] border border-[var(--theme-border,#213E61)] rounded-xl px-3.5 py-2 text-[13px] text-[var(--theme-text,#F8FAFC)] focus:outline-none focus:border-[var(--theme-secondary,#FFC700)]"
              />
            </div>
          </div>
          ...
          <div className="space-y-1.5">
            <label className="font-bold uppercase tracking-wider text-[11.5px] text-[var(--theme-text-dim,#94A3B8)] flex items-center justify-between">
              <span>
            ...
            <textarea
              ...
              className="w-full bg-[var(--theme-bg,#070E18)] border border-[var(--theme-border,#213E61)] rounded-xl px-3.5 py-2.5 text-[13.5px] text-[var(--theme-text,#F8FAFC)] leading-relaxed focus:outline-none focus:border-[var(--theme-secondary,#FFC700)]"
              autoFocus
            />
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-1.5">
              <label className="font-bold uppercase tracking-wider text-[11px] text-[var(--theme-text-dim,#94A3B8)] flex items-center gap-1">
              ...
              <NativeTimePicker
                ...
                className="w-full bg-[var(--theme-bg,#070E18)] border border-[var(--theme-border,#213E61)] rounded-xl px-2 py-1.5 text-[12.5px] text-[var(--theme-text,#F8FAFC)] font-mono focus:outline-none"
              />
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
              <div className="space-y-1">
                ...
                <input
                  ...
                  className="w-full bg-[var(--theme-bg,#070E18)] border border-[var(--theme-border,#213E61)] rounded-xl px-3 py-1.5 text-[12px] text-[var(--theme-text,#F8FAFC)] focus:outline-none"
                />
              </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div className="space-y-1">
              ...
              <input
                ...
                className="w-full bg-[var(--theme-bg,#070E18)] border border-[var(--theme-border,#213E61)] rounded-xl px-3 py-1.5 text-[12.5px] text-[var(--theme-text,#F8FAFC)] focus:outline-none"
              />
            </div>
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-2 pt-1">
              <input
                ...
                className="flex-1 bg-[var(--theme-bg,#070E18)] border border-[var(--theme-border,#213E61)] rounded-xl px-3 py-1.5 text-[12px] text-[var(--theme-text,#F8FAFC)] focus:outline-none"
              />
              <button
                type="button"
        ...
        <div className="p-4 border-t border-[var(--theme-border,#213E61)] bg-[var(--theme-surface,#0E1A29)] flex items-center justify-end gap-2.5">
          <button
            type="button"
            onClick={onClose}
            className="px-4 py-2.5 rounded-xl bg-[var(--theme-bg,#070E18)] text-[var(--theme-text-dim,#94A3B8)] hover:text-[var(--theme-text,#F8FAFC)] font-bold text-[13px] border border-[var(--theme-border,#213E61)] transition-colors cursor-pointer"
          >
