        ...
        <form onSubmit={handleSubmit} className="p-5 overflow-y-auto space-y-4 text-[13px] flex-1">
          ...
          <div className="space-y-1.5">
            ...
            <input
              ...
              className="w-full bg-[var(--theme-bg,#070E18)] border border-[var(--theme-border,#213E61)] rounded-xl px-3.5 py-2.5 text-[13.5px] text-[var(--theme-text,#F8FAFC)] focus:outline-none focus:border-[var(--theme-primary,#38BDF8)]"
              autoFocus
            />
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div className="space-y-1.5">
              ...
              <input
                ...
                className="w-full bg-[var(--theme-bg,#070E18)] border border-[var(--theme-border,#213E61)] rounded-xl px-3.5 py-2 text-[13px] text-[var(--theme-text,#F8FAFC)] focus:outline-none focus:border-[var(--theme-primary,#38BDF8)]"
              />
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <input
                ...
                className="w-full bg-[var(--theme-bg,#070E18)] border border-[var(--theme-border,#213E61)] rounded-xl px-3.5 py-2 text-[13px] text-[var(--theme-text,#F8FAFC)] font-mono focus:outline-none focus:border-[var(--theme-primary,#38BDF8)]"
              />
            </div>
          </div>
            ...
            {isAddingCustomCat && (
              <div className="p-2.5 bg-[var(--theme-surface,#0E1A29)] border border-[var(--theme-primary,#38BDF8)]/50 rounded-xl flex gap-2 animate-in fade-in duration-150">
                <input
                  ...
                  className="flex-1 bg-[var(--theme-bg,#070E18)] border border-[var(--theme-border,#213E61)] rounded-lg px-3 py-1.5 text-[12.5px] text-[var(--theme-text,#F8FAFC)] focus:outline-none"
                  autoFocus
                />
                <button
                  type="button"
            ...
            {deliverables.length > 0 && (
              <div className="flex flex-wrap gap-1.5 pt-1">
                {deliverables.map((d, index) => (
                  <span
                    key={index}
                    className="px-2 py-1 rounded-lg bg-[var(--theme-surface,#0E1A29)] text-[var(--theme-text-muted,#CBD5E1)] text-[11.5px] font-medium border border-[var(--theme-border,#213E61)] flex items-center gap-1.5"
                  >
                    ...
                    <button
                      ...
                      className="text-[var(--theme-text-dim,#94A3B8)] hover:text-[#EF4444] cursor-pointer ml-0.5"
                    >
                      <X className="w-3 h-3" />
                    </button>
                  </span>
