...
export const SupportPage: React.FC<SupportPageProps> = ({
  ...
  const handleShareApp = async () => {
    ...
    const shareText = isHindi
      ? 'Daily Khata Pro: 100% प्राइवेट, ऑफलाइन और स्मार्ट फंड्स मैनेजमेंट ऐप:'
      : 'Daily Khata Pro: 100% Private, Offline-first, Smart Funds & Personal Finance Manager:';
      ...
      <div className="bg-[var(--theme-card,#132438)] border border-[var(--theme-border,#213E61)] rounded-3xl p-5 sm:p-7 shadow-2xl space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-5 border-b border-[var(--theme-border,#213E61)]">
          <div className="flex items-center gap-3.5">
            <AppLogo size={36} />
            <div>
              <h1 className="text-xl sm:text-2xl font-extrabold text-[var(--theme-text,#F8FAFC)] tracking-tight">
                {isHindi ? 'सहायता एवं फीडबैक केंद्र' : 'Help & Support Centre'}
              </h1>
          ...
          <div className="flex items-center gap-2 px-3 py-1.5 rounded-xl bg-[var(--theme-surface,#0E1A29)] border border-[var(--theme-border,#213E61)] text-[12px]">
            ...
            <a
              ...
              className="font-mono text-[var(--theme-text-muted,#CBD5E1)] hover:text-[var(--theme-primary,#38BDF8)] font-semibold transition-colors"
            >
              {officialEmail}
            </a>
          </div>
          ...
          <button
            ...
            className={`flex-1 flex flex-col sm:flex-row items-center justify-center gap-1 sm:gap-2 py-2 sm:py-2.5 px-1 sm:px-3 rounded-xl font-bold text-[10.5px] sm:text-[12.5px] text-center leading-tight transition-all cursor-pointer ${
              activeTab === 'help'
                ...
                : 'text-[var(--theme-text-dim,#94A3B8)] hover:text-[var(--theme-text,#F8FAFC)] hover:bg-[var(--theme-card,#132438)]'
            }`}
          >
          ...
          <div className="space-y-6 animate-in fade-in duration-200">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
              ...
              >
                ...
                <div>
                  <div className="text-[13.5px] font-bold text-[var(--theme-text,#F8FAFC)] group-hover:text-[var(--theme-primary,#38BDF8)] transition-colors">
                    {isHindi ? 'विस्तृत यूजर मैनुअल गाइड' : 'Interactive User Manual'}
                  </div>
                  <div className="text-[12px] text-[var(--theme-text-dim,#94A3B8)] mt-0.5">
                    {isHindi ? 'स्मार्ट फंड सिस्टम, बैकअप, और सभी फीचर्स की पूरी गाइड' : 'Complete step-by-step documentation & tutorials'}
                  </div>
                </div>
              </button>
            ...
            <div className="p-4 sm:p-5 rounded-2xl bg-[var(--theme-surface,#0E1A29)] border border-[var(--theme-border,#213E61)] space-y-3">
              <div className="flex items-center justify-between flex-wrap gap-2">
                ...
                <span className="text-[11px] text-[var(--theme-text-dim,#94A3B8)]">Response within 24h</span>
              </div>

              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2.5 flex-wrap">
                <a
                  href={`mailto:${officialEmail}?subject=Daily%20Khata%20Pro%20Support%20Request`}
                  className="flex-1 min-w-[200px] px-4 py-2.5 rounded-xl bg-[var(--theme-card,#132438)] border border-[var(--theme-border,#213E61)] hover:border-[var(--theme-primary,#38BDF8)] text-[12.5px] text-[var(--theme-text-muted,#CBD5E1)] hover:text-[var(--theme-text,#F8FAFC)] flex items-center justify-between transition-colors font-mono"
                >
                  <div className="flex items-center gap-2">
                    <Mail className="w-4 h-4 text-[var(--theme-primary,#38BDF8)]" />
                ...
                <a
                  ...
                  className="px-4 py-2.5 rounded-xl bg-amber-500/10 hover:bg-amber-500/20 border border-amber-500/30 hover:border-amber-400 text-[12.5px] text-amber-400 flex items-center gap-2 transition-colors font-bold"
                >
                ...
                <button
                  ...
                  className="px-4 py-2.5 rounded-xl bg-pink-600/15 hover:bg-pink-600/25 border border-pink-500/30 hover:border-pink-400 text-[12.5px] text-pink-400 flex items-center gap-2 transition-colors font-bold cursor-pointer"
                >
            ...
            <div className="space-y-3 pt-2">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2.5">
                <h3 className="text-[14.5px] font-bold text-[var(--theme-text,#F8FAFC)] flex items-center gap-2">
                ...
                <input
                  ...
                  className="px-3 py-1.5 rounded-xl bg-[var(--theme-surface,#0E1A29)] border border-[var(--theme-border,#213E61)] text-[12px] text-[var(--theme-text,#F8FAFC)] placeholder-[#64748B] focus:outline-none focus:border-[var(--theme-primary,#38BDF8)] w-full sm:w-64"
                />
              </div>
                ...
                {filteredFaqs.map((faq) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {isOpen && (
                        <div className="px-4 pb-4 pt-1 text-[12.5px] leading-relaxed text-[var(--theme-text-dim,#94A3B8)] border-t border-[var(--theme-border,#213E61)]/40">
        ...
        {activeTab === 'bug' && (
          <div className="space-y-5 animate-in fade-in duration-200">
            ...
            {/* Bug Title */}
            <div>
              <label className="block text-[12px] font-bold text-[var(--theme-text-muted,#CBD5E1)] mb-1.5">
              ...
              <input
                ...
                className="w-full px-3.5 py-2.5 rounded-xl bg-[var(--theme-surface,#0E1A29)] border border-[var(--theme-border,#213E61)] text-[13px] text-[var(--theme-text,#F8FAFC)] placeholder-[#64748B] focus:outline-none focus:border-[#EF4444]"
              />
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
              <div>
                ...
                <select
                  ...
                  className="w-full px-3.5 py-2.5 rounded-xl bg-[var(--theme-surface,#0E1A29)] border border-[var(--theme-border,#213E61)] text-[13px] text-[var(--theme-text,#F8FAFC)] focus:outline-none focus:border-[#EF4444]"
                >
              ...
              <div>
                ...
                <div className="px-3.5 py-2.5 rounded-xl bg-[var(--theme-surface,#0E1A29)] border border-[var(--theme-border,#213E61)] text-[11px] text-[var(--theme-text-dim,#94A3B8)] font-mono truncate">
                  {getSystemInfo()}
                </div>
              </div>
            </div>
            ...
            <div className="pt-2 flex flex-wrap items-center gap-3">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="px-4 py-2.5 rounded-xl bg-[var(--theme-surface,#0E1A29)] border border-[var(--theme-border,#213E61)] hover:border-[#F8FAFC]/40 text-[var(--theme-text-muted,#CBD5E1)] hover:text-[var(--theme-text,#F8FAFC)] font-semibold text-[13px] flex items-center gap-2 transition-colors cursor-pointer"
              >
              ...
              <button
                ...
                className="px-4 py-2.5 rounded-xl bg-[var(--theme-surface,#0E1A29)] border border-[var(--theme-border,#213E61)] hover:border-[var(--theme-primary,#38BDF8)] text-[var(--theme-text-dim,#94A3B8)] hover:text-[var(--theme-text,#F8FAFC)] font-medium text-[13px] flex items-center gap-2 transition-colors cursor-pointer ml-auto"
              >
          ...
          <div className="space-y-5 animate-in fade-in duration-200">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-3.5 py-2.5 rounded-xl bg-[var(--theme-surface,#0E1A29)] border border-[var(--theme-border,#213E61)] text-[13px] text-[var(--theme-text,#F8FAFC)] placeholder-[#64748B] focus:outline-none focus:border-[#F59E0B]"
              />
            </div>
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-3.5 py-2.5 rounded-xl bg-[var(--theme-surface,#0E1A29)] border border-[var(--theme-border,#213E61)] text-[13px] text-[var(--theme-text,#F8FAFC)] focus:outline-none focus:border-[#F59E0B]"
              >
