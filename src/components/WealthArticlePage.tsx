...
export const WealthArticlePage: React.FC<WealthArticlePageProps> = ({
  ...
  return (
    <div className="min-h-screen bg-[var(--theme-bg,#070E18)] text-[var(--theme-text,#F8FAFC)]">
      {/* Header */}
      ...
      <div className="max-w-3xl mx-auto p-4 md:p-8 space-y-8 pb-32">
        ...
        <div className="space-y-4 text-center md:text-left">
          ...
          <h1 className="text-3xl md:text-4xl font-extrabold text-[var(--theme-text,#F8FAFC)] leading-tight">
            {tStr(article.hindiTitle, article.title)}
          </h1>
          
          <div className="flex items-center justify-center md:justify-start gap-4 text-[var(--theme-text-dim,#94A3B8)] text-[13px]">
        ...
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          className="prose prose-invert max-w-none prose-headings:text-[var(--theme-primary,#38BDF8)] prose-p:text-[var(--theme-text-muted,#CBD5E1)] prose-p:leading-loose text-[16px] md:text-[18px]"
        >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {prevArticle ? (
            ...
            >
              <div className="flex items-center gap-2 text-[11px] text-[var(--theme-text-dim,#94A3B8)] mb-1">
                <ChevronLeft className="w-3.5 h-3.5" />
                <span>PREVIOUS</span>
              </div>
              <div className="font-bold text-[13.5px] text-[var(--theme-text,#F8FAFC)] line-clamp-1 group-hover:text-[var(--theme-primary,#38BDF8)]">
          ...
          {nextArticle ? (
            ...
            >
              <div className="flex items-center justify-end gap-2 text-[11px] text-[var(--theme-text-dim,#94A3B8)] mb-1">
                <span>NEXT</span>
