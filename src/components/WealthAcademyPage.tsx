      ...
      <div className="max-w-4xl mx-auto p-4 space-y-6 pb-24">
        ...
        <div className="relative group">
          <div className="absolute inset-y-0 left-4 flex items-center pointer-events-none">
            <Search className="w-4 h-4 text-[var(--theme-text-dim,#94A3B8)] group-focus-within:text-[var(--theme-primary,#38BDF8)] transition-colors" />
          </div>
          <input
            type="text"
              ...
              <button
                ...
                className={`flex items-center gap-2 px-4 py-2.5 rounded-xl border text-[13px] font-bold transition-all whitespace-nowrap ${
                  isActive
                    ...
                    : 'bg-[var(--theme-surface,#0E1A29)] border-[var(--theme-border,#213E61)] text-[var(--theme-text-dim,#94A3B8)] hover:border-[#38BDF8]/50'
                }`}
              >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {filteredArticles.length > 0 ? (
              ...
              return (
                ...
                >
                  ...
                  <div className="space-y-1">
                    <h3 className="font-bold text-[14.5px] text-[var(--theme-text,#F8FAFC)] line-clamp-1 group-hover:text-[var(--theme-primary,#38BDF8)] transition-colors">
                      {tStr(article.hindiTitle, article.title)}
                    </h3>
                    <p className="text-[12px] text-[var(--theme-text-dim,#94A3B8)] line-clamp-2 leading-relaxed">
            ...
            <div className="col-span-full py-12 text-center space-y-3">
              ...
              <p className="text-[var(--theme-text-dim,#94A3B8)] font-medium">{tStr('कोई लेख नहीं मिला', 'No articles found')}</p>
            </div>
          )}
        </div>
