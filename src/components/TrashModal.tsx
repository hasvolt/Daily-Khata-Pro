...
export const TrashModal: React.FC<TrashModalProps> = ({
  ...
  const getItemTypeBadge = (type: TrashItemType) => {
    switch (type) {
      ...
      default:
        return { label: 'Item', color: 'text-[var(--theme-text-dim,#94A3B8)] bg-[#94A3B8]/10 border-[#94A3B8]/30' };
    }
  };
          ...
          <div className="relative w-full">
            ...
            {searchQuery && (
              <button
                ...
                className="absolute right-3 top-1/2 -translate-y-1/2 text-xs text-[var(--theme-text-dim,#94A3B8)] hover:text-white"
              >
                Clear
              </button>
            )}
        ...
        <div className="flex-1 overflow-y-auto p-3 sm:p-5 space-y-2.5">
          {filteredItems.length === 0 ? (
            <div className="text-center py-14 px-4 space-y-3">
              <div className="w-14 h-14 rounded-2xl bg-[var(--theme-surface,#0E1A29)] border border-[var(--theme-border,#213E61)] flex items-center justify-center mx-auto text-[var(--theme-text-dim,#94A3B8)]">
                  ...
                  <div className="flex items-center gap-3 min-w-0 flex-1">
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="flex items-center gap-2 flex-wrap mb-0.5">
                        ...
                        <span className="text-[10px] text-[var(--theme-text-dim,#94A3B8)] font-mono flex items-center gap-1">
                      ...
                      {item.subtitle && (
                        <div className="text-[11.5px] text-[var(--theme-text-dim,#94A3B8)] truncate mt-0.5">
                          {item.subtitle}
                        </div>
                      )}
                    </div>
                  ...
                  <div className="flex items-center gap-2 sm:gap-3 shrink-0">
                    ...
                    <div className="flex items-center gap-1.5 pl-2 border-l border-[var(--theme-border,#213E61)]">
                      ...
                      <button
                        ...
                        className="p-1.5 rounded-lg text-[var(--theme-text-dim,#94A3B8)] hover:text-[#EF4444] hover:bg-[#EF4444]/15 border border-transparent hover:border-[#EF4444]/30 transition-all cursor-pointer"
