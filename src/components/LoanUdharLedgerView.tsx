...
<head>
  ...
  <style>
    @page {
      ...
      @bottom-center {
        content: "Generated By Daily Khata pro • www.rozfiber.com";
        font-size: 8.5pt;
        font-weight: 700;
        color: #475569;
      }
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    body { font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Arial, sans-serif; padding: 24px; padding-bottom: 26px; color: #0f172a; max-width: 820px; margin: 0 auto; line-height: 1.45; background: #fff; }
    ...
    .page-footer-running { display: none; }
    @media print {
      body { padding: 0; padding-bottom: 22px; }
      .page-footer-running {
...
<body>
  ...
  <div class="doc-end-divider">
    System Generated Report by Daily Khata Pro • www.rozfiber.com
  </div>
  <div class="page-footer-running">Generated By Daily Khata pro • www.rozfiber.com</div>
</body>
</html>`;
