        ...
        <div className="lg:col-span-6 space-y-4 w-full min-w-0">
          ...
          <div className="bg-gradient-to-br from-[var(--theme-card,#132438)] to-[var(--theme-surface,#0E1A29)] border border-[var(--theme-border,#213E61)] rounded-2xl p-3.5 sm:p-5 shadow-md hover:shadow-[0_8px_25px_rgba(0,0,0,0.15)] hover:border-[var(--theme-primary,#38BDF8)]/30 transition-all duration-300 space-y-3.5 min-w-0">
            <div className="flex justify-between items-center gap-2">
              <span className="text-[11px] uppercase tracking-wider text-[var(--theme-text-dim,#94A3B8)] font-bold flex items-center gap-1.5 truncate">
              ...
              <span className="text-[11px] text-[var(--theme-text-dim,#94A3B8)] shrink-0 font-medium">
            ...
            <div className="grid grid-cols-3 gap-1.5 sm:gap-2.5">
              <div className="bg-[var(--theme-bg,#070E18)] p-2 sm:p-3 rounded-xl border border-[var(--theme-border,#213E61)] text-center min-w-0">
                <span className="text-[9.5px] sm:text-[10px] text-[var(--theme-text-dim,#94A3B8)] uppercase tracking-wider block font-semibold truncate">{t.home?.thisMonthIncome || 'Income'}</span>
              ...
              <div className="bg-[var(--theme-bg,#070E18)] p-2 sm:p-3 rounded-xl border border-[var(--theme-border,#213E61)] text-center min-w-0">
                <span className="text-[9.5px] sm:text-[10px] text-[var(--theme-text-dim,#94A3B8)] uppercase tracking-wider block font-semibold truncate">{t.home?.thisMonthExpense || 'Expense'}</span>
              ...
              <div className="bg-[var(--theme-bg,#070E18)] p-2 sm:p-3 rounded-xl border border-[var(--theme-border,#213E61)] text-center min-w-0">
                <span className="text-[9.5px] sm:text-[10px] text-[var(--theme-text-dim,#94A3B8)] uppercase tracking-wider block font-semibold truncate">{t.home?.netSavings || 'Surplus'}</span>
                <span
            ...
            <div className="space-y-1 pt-1">
              <div className="flex justify-between text-[11px] text-[var(--theme-text-dim,#94A3B8)]">
          ...
          <div className="bg-gradient-to-br from-[var(--theme-card,#132438)] to-[var(--theme-surface,#0E1A29)] border border-[var(--theme-border,#213E61)] rounded-2xl p-3.5 sm:p-5 shadow-md hover:shadow-[0_8px_25px_rgba(0,0,0,0.15)] hover:border-[var(--theme-primary,#38BDF8)]/30 transition-all duration-300 space-y-3.5 min-w-0">
            <h3 className="font-serif-display text-[14px] sm:text-[15px] font-bold text-[var(--theme-text,#F8FAFC)] flex items-center justify-between gap-2">
              ...
              <span className="text-[11px] font-sans text-[var(--theme-text-dim,#94A3B8)] shrink-0">{catEntries.length} categories</span>
            </h3>

            {catEntries.length === 0 ? (
              <div className="text-center text-[var(--theme-text-dim,#94A3B8)] py-8 text-[12.5px] border border-dashed border-[var(--theme-border,#213E61)] rounded-xl bg-[var(--theme-bg,#070E18)]/40">
                    ...
                    <div key={cat} className="space-y-1">
                      <div className="flex justify-between items-center text-[12px] sm:text-[12.5px] gap-2">
                        <div className="flex items-center gap-1.5 sm:gap-2 min-w-0 flex-1">
                          ...
                          <span className="text-[10px] text-[var(--theme-text-dim,#94A3B8)] font-mono shrink-0">({pctOfTotal}%)</span>
                        </div>
        ...
        <div className="lg:col-span-6 space-y-4 w-full min-w-0">
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-2 min-w-0 flex-1">
                      ...
                      <span className="text-[var(--theme-text-dim,#94A3B8)] font-medium truncate">{fundLabel}</span>
                    </div>
                    <span
          ...
          <div className="bg-gradient-to-br from-[var(--theme-card,#132438)] to-[var(--theme-surface,#0E1A29)] border border-[var(--theme-border,#213E61)] rounded-2xl p-3.5 sm:p-5 shadow-md hover:shadow-[0_8px_25px_rgba(0,0,0,0.15)] hover:border-[var(--theme-primary,#38BDF8)]/30 transition-all duration-300 space-y-3.5 w-full min-w-0 overflow-hidden">
            ...
            <div className="flex flex-wrap items-center justify-between gap-2">
              <div className="min-w-0 flex-1">
                ...
                <p className="text-[11px] text-[var(--theme-text-dim,#94A3B8)] line-clamp-1 sm:line-clamp-none mt-0.5">
                  {isHindi
                  ...
                  >
                    ...
                    <div className="flex items-center gap-1 shrink-0">
                      <button
                        ...
                        className="w-6 h-6 rounded-md bg-[var(--theme-surface,#0E1A29)] border border-[var(--theme-border,#213E61)] text-[var(--theme-text-dim,#94A3B8)] hover:text-[var(--theme-text,#F8FAFC)] hover:border-[var(--theme-primary,#38BDF8)] flex items-center justify-center cursor-pointer transition-colors active:scale-95 text-xs font-bold"
                        title="-5%"
                      >
          ...
          <div className="bg-gradient-to-br from-[var(--theme-card,#132438)] to-[var(--theme-surface,#0E1A29)] border border-[var(--theme-border,#213E61)] rounded-2xl p-3.5 sm:p-5 shadow-md hover:shadow-[0_8px_25px_rgba(0,0,0,0.15)] hover:border-[var(--theme-primary,#38BDF8)]/30 transition-all duration-300 space-y-3 min-w-0">
            <h3 className="font-serif-display text-[14px] sm:text-[15px] font-bold text-[var(--theme-text,#F8FAFC)] flex items-center justify-between gap-2">
              ...
              <span className="text-[11px] text-[var(--theme-text-dim,#94A3B8)] shrink-0">{categories.length} Active</span>
            </h3>
            ...
            <div className="flex flex-wrap gap-1.5 pt-1 max-h-36 overflow-y-auto min-w-0">
              {categories.map((cat) => {
                ...
                return (
                  <span
                    key={cat}
                    className="inline-flex items-center gap-1.5 bg-[var(--theme-bg,#070E18)] text-[var(--theme-text-dim,#94A3B8)] hover:text-[var(--theme-text,#F8FAFC)] border border-[var(--theme-border,#213E61)] px-2.5 py-1 rounded-lg text-[11px] transition-colors max-w-full"
                  >
