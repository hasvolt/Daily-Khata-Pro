...
export const InstallPWA: React.FC<InstallPWAProps> = ({
  ...
  return (
    <div className="fixed bottom-[74px] sm:bottom-[80px] left-1/2 -translate-x-1/2 z-40 animate-in fade-in slide-in-from-bottom-4 duration-500 w-[94%] max-w-md no-print pointer-events-auto">
      <div className="bg-[var(--theme-surface,#0E1A29)]/95 text-[var(--theme-text,#F8FAFC)] backdrop-blur-xl p-3 sm:p-3.5 rounded-2xl shadow-2xl border border-[var(--theme-primary,#38BDF8)]/40 flex items-center justify-between gap-3 shadow-[var(--theme-primary,#38BDF8)]/10">
        <div
          onClick={handleClick}
        ...
        >
          ...
          <div className="flex flex-col min-w-0">
            ...
            <span className="text-[11px] text-[var(--theme-text-dim,#94A3B8)] truncate">
        ...
        <div className="flex items-center gap-1.5 shrink-0">
          ...
          <button
            ...
            className="p-1.5 text-[var(--theme-text-dim,#94A3B8)] hover:text-[var(--theme-text,#F8FAFC)] hover:bg-white/10 rounded-lg transition-colors cursor-pointer"
            aria-label="Dismiss"
          >
            <X className="w-4 h-4" />
          </button>
