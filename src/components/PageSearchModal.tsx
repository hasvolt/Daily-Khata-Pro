...
export const PageSearchModal: React.FC<PageSearchModalProps> = ({
  ...
  const searchItems: SearchItem[] = useMemo(() => [
    ...
    {
      id: 'history',
      title: isHindi ? 'लेन-देन इतिहास और रिकॉर्ड्स' : 'History & Search Records',
      ...
      targetTab: 'history',
      routePath: '/history',
      keywords: ['history', 'records', 'entries', 'search', 'filter', 'csv', 'excel', 'इतिहास', 'खोज', 'प्रविष्टियां', 'रिकॉर्ड']
    },
    {
      id: 'reports',
    ...
    },
    {
      ...
      subtitle: isHindi ? 'दोस्तों, परिवार व व्यापारियों के साथ ऐप का लिंक साझा करें' : 'Share the offline financial records app via WhatsApp, Telegram, etc.',
      category: 'settings',
      categoryLabel: isHindi ? 'सेटिंग्स एवं सुरक्षा' : 'Settings & Security',
      icon: Share2,
      targetTab: 'share',
    ...
    },
    {
      ...
      subtitle: isHindi ? 'मिशन, 6-फंड सिद्धांत, ऑफ़लाइन आर्किटेक्चर और विशेषताएं' : 'Universal mission, 6-fund system, zero-knowledge architecture',
      category: 'docs',
    ...
    {
      id: 'developer',
      title: isHindi ? 'डेवलपर प्रोफाइल (MD Zafeer Hasan)' : 'Developer Profile (MD Zafeer Hasan - YAZDAAN)',
      subtitle: isHindi ? 'स्वतंत्र डेवलपर, विकास दर्शन व ओपन सोर्स रिपॉजिटरी' : 'Independent developer background, philosophy & open-source transparency',
      category: 'docs',
      categoryLabel: isHindi ? 'नीतियां व सहायता' : 'Documentation & Help',
      icon: User,
      targetTab: 'developer',
      routePath: '/developer',
      keywords: ['developer', 'zafeer', 'hasan', 'yazdaan', 'profile', 'author', 'डेवलपर', 'जफीर', 'हसन']
    },
    {
      id: 'guide',
  ...
  const categoriesList: { id: SearchCategory; label: string; icon: React.ComponentType<{ className?: string }> }[] = [
    ...
    { id: 'finance', label: isHindi ? 'हिसाब व फंड्स' : 'Records', icon: Home },
