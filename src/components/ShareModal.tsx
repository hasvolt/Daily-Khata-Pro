    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-black/85 backdrop-blur-sm animate-in fade-in duration-150 no-print">
      <div className="bg-[#0B1017] border border-[var(--theme-border,#213E61)] rounded-2xl w-full max-w-lg max-h-[92vh] flex flex-col shadow-2xl overflow-hidden text-left">
        ...
        <div className="p-4 sm:p-5 border-b border-[var(--theme-border,#213E61)] flex items-center justify-between bg-[var(--theme-surface,#0E1A29)]">
          ...
          <button
            onClick={onClose}
            className="w-8 h-8 rounded-lg hover:bg-white/10 flex items-center justify-center text-[var(--theme-text-dim,#94A3B8)] hover:text-[var(--theme-text,#F8FAFC)] transition-colors cursor-pointer"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
        ...
        <div className="p-4 sm:p-5 space-y-4 overflow-y-auto bg-[#070E18]">
            ...
            <div className="pt-2 flex flex-wrap items-center gap-2">
              {typeof navigator !== 'undefined' && (
                <button
                  ...
                  className="px-3.5 py-1.5 rounded-lg bg-[#132438] hover:bg-[#1E3A5F] border border-[var(--theme-border,#213E61)] text-[var(--theme-text,#F8FAFC)] text-[11.5px] font-bold flex items-center gap-1.5 transition-all cursor-pointer shadow-xs active:scale-95"
                >
              ...
              <a
                ...
                className="px-3.5 py-1.5 rounded-lg bg-[#132438] hover:bg-[#1E3A5F] border border-[var(--theme-border,#213E61)] text-[var(--theme-text-muted,#CBD5E1)] text-[11.5px] font-bold flex items-center gap-1.5 transition-all cursor-pointer active:scale-95"
              >
          ...
          <div className="space-y-2">
            <h4 className="text-[12px] font-bold uppercase tracking-wider text-[var(--theme-text-dim,#94A3B8)]">
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-2.5 min-w-0">
                      <div
                        className={`w-8 h-8 rounded-lg flex items-center justify-center shrink-0 ${
                          isSelected ? 'bg-[var(--theme-primary,#38BDF8)] text-[#040D17]' : 'bg-[#070E18] text-[var(--theme-text-dim,#94A3B8)]'
                        }`}
                      >
                        <Icon className="w-4 h-4" />
                      </div>
                      <div className="min-w-0">
                        <div className="text-[12.5px] font-bold text-[var(--theme-text,#F8FAFC)] truncate">{item.label}</div>
                        <div className="text-[10.5px] text-[var(--theme-text-dim,#94A3B8)] truncate">{item.desc}</div>
                      </div>
                    </div>
                    ...
                    <button
                      ...
                      className="p-1.5 rounded-md hover:bg-white/10 text-[var(--theme-text-muted,#CBD5E1)] hover:text-[var(--theme-primary,#38BDF8)] transition-colors shrink-0"
