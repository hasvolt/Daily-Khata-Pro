      ...
      >
        ...
        <div className="p-4 sm:p-5 border-b border-[var(--theme-border,#213E61)] flex items-center justify-between gap-3 bg-[var(--theme-surface,#0E1A29)]">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h3 className="font-bold text-[15px] sm:text-[17px] text-[var(--theme-text,#F8FAFC)]">
                {isHindi ? 'होमपेज श्रेणियां कस्टमाइज़ करें' : 'Customize Homepage Categories'}
              </h3>
              <p className="text-[11px] sm:text-[12px] text-[var(--theme-text-dim,#94A3B8)]">
                {isHindi
          ...
          <button
            type="button"
            onClick={onClose}
            className="p-1.5 rounded-lg text-[var(--theme-text-dim,#94A3B8)] hover:text-[var(--theme-text,#F8FAFC)] hover:bg-[var(--theme-card-hover,#19304A)] transition-colors cursor-pointer"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
        ...
        <div className="px-4 py-2.5 bg-[var(--theme-bg,#070E18)] border-b border-[var(--theme-border,#213E61)] flex items-center justify-between text-[11.5px] sm:text-[12.5px]">
          <div className="flex items-center gap-1.5">
            <span className="text-[var(--theme-text-dim,#94A3B8)]">{isHindi ? 'चयनित श्रेणियां:' : 'Selected on Home:'}</span>
            <span
        ...
        <div className="p-4 overflow-y-auto space-y-2 flex-1">
          <p className="text-[11px] text-[var(--theme-text-dim,#94A3B8)] pb-1">
            {isHindi
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-2.5 min-w-0 flex-1">
                    <span className="w-5 text-center font-mono font-bold text-[12px] text-[var(--theme-text-dim,#94A3B8)]">
                      #{index + 1}
                    </span>
                    <div
                    ...
                    <div className="min-w-0 flex-1">
                      <span className="font-bold text-[13px] text-[var(--theme-text,#F8FAFC)] block truncate">
                        {cfg.label}
                      </span>
                  ...
                  <div className="flex items-center gap-1 shrink-0">
                    <button
                      ...
                      className="p-1 rounded-lg bg-[var(--theme-card,#132438)] border border-[var(--theme-border,#213E61)] text-[var(--theme-text-dim,#94A3B8)] hover:text-[var(--theme-text,#F8FAFC)] disabled:opacity-30 cursor-pointer disabled:cursor-not-allowed"
                      title="Move Up"
                    >
          ...
          {funds.filter((f) => !selectedIds.includes(f.id)).length > 0 && (
            <div className="space-y-1.5 pt-3 border-t border-[var(--theme-border,#213E61)] mt-3">
              <div className="text-[11px] font-bold text-[var(--theme-text-dim,#94A3B8)] uppercase tracking-wider flex items-center gap-1.5">
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center gap-2.5 min-w-0 flex-1">
                        ...
                        <div className="min-w-0 flex-1">
                          <span className="font-bold text-[13px] text-[var(--theme-text-muted,#CBD5E1)] block truncate">
                            {cfg.label}
                          </span>
        ...
        <div className="p-4 border-t border-[var(--theme-border,#213E61)] bg-[var(--theme-surface,#0E1A29)] flex items-center justify-between gap-2">
          {onOpenFundSettings ? (
            <button
              ...
              className="text-[11.5px] text-[var(--theme-text-dim,#94A3B8)] hover:text-[var(--theme-primary,#38BDF8)] underline cursor-pointer"
            >
          ...
          <div className="flex items-center gap-2">
            <button
              type="button"
              onClick={onClose}
              className="px-3.5 py-2 rounded-xl bg-[var(--theme-card,#132438)] border border-[var(--theme-border,#213E61)] text-[var(--theme-text-muted,#CBD5E1)] hover:text-[var(--theme-text,#F8FAFC)] font-semibold text-[12px] cursor-pointer"
            >
