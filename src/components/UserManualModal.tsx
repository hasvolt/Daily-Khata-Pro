      ...
      <div className="bg-[var(--theme-surface,#0E1A29)] sm:border border-[var(--theme-border,#213E61)] rounded-none sm:rounded-2xl w-full h-full sm:h-auto sm:max-h-[92vh] max-w-5xl shadow-lg flex flex-col overflow-hidden text-left">
        ...
        <div className="px-4 sm:px-5 py-3 sm:py-4 border-b border-[var(--theme-border,#213E61)] flex items-center justify-between bg-[var(--theme-bg,#070E18)] shrink-0">
          <div className="flex items-center gap-3 min-w-0 flex-1 mr-2">
            ...
            <div className="min-w-0 flex-1">
              <div className="flex items-center gap-2">
                <h2 className="font-serif-display text-[16px] sm:text-[20px] font-bold text-[var(--theme-text,#F8FAFC)] truncate">
                  {manual.title}
                </h2>
              ...
              <p className="text-[11.5px] sm:text-[12px] text-[var(--theme-text-dim,#94A3B8)] truncate">
                {manual.subtitle}
              </p>
            </div>
          </div>
          <button
            type="button"
            onClick={onClose}
            className="w-8 h-8 rounded-lg bg-[var(--theme-surface,#0E1A29)] border border-[var(--theme-border,#213E61)] flex items-center justify-center text-[var(--theme-text-dim,#94A3B8)] hover:text-[var(--theme-text,#F8FAFC)] hover:bg-[var(--theme-card,#132438)] transition-all cursor-pointer shrink-0"
          >
            <X className="w-4 h-4" />
          </button>
        </div>
            ...
            <div className="p-3 border-b border-[var(--theme-border,#213E61)]">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-9 pr-8 py-2 text-[12.5px] rounded-xl bg-[var(--theme-surface,#0E1A29)] border border-[var(--theme-border,#213E61)] text-[var(--theme-text,#F8FAFC)] placeholder-[#64748B] focus:outline-none focus:border-[var(--theme-primary,#38BDF8)]"
                />
                {searchQuery && (
                  <button
                    type="button"
                    onClick={() => setSearchQuery('')}
                    className="absolute right-2.5 top-1/2 -translate-y-1/2 text-[#64748B] hover:text-[var(--theme-text,#F8FAFC)]"
                  >
                  ...
                  <button
                    ...
                    className={`w-full flex items-start gap-3 p-2.5 rounded-xl text-left transition-all cursor-pointer border ${
                      isActive
                        ...
                        : 'border-transparent text-[var(--theme-text-dim,#94A3B8)] hover:bg-[var(--theme-surface,#0E1A29)] hover:text-[var(--theme-text,#F8FAFC)]'
                    }`}
                  >
                    <div
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="flex items-center justify-between gap-1">
                        <div className="text-[12.5px] font-bold text-[var(--theme-text,#F8FAFC)] truncate">
                          {s.title}
                        </div>
                        <span className="text-[10px] font-mono opacity-60">#{idx + 1}</span>
                      </div>
                      <div className="text-[11px] text-[var(--theme-text-dim,#94A3B8)] line-clamp-1 mt-0.5">
                        {s.subtitle}
                      </div>
                    </div>
                  </button>
            ...
            {currentSection && (
              <div className="space-y-5 sm:space-y-6 animate-in fade-in duration-200">
                ...
                <div className="bg-[var(--theme-card,#132438)] border border-[var(--theme-border,#213E61)] rounded-2xl p-4 sm:p-5 space-y-2.5 shadow-sm">
                    ...
                    <div className="hidden sm:flex items-center gap-1">
                      {prevSection && (
                        <button
                          ...
                          className="px-2 py-1 rounded-lg bg-[var(--theme-bg,#070E18)] border border-[var(--theme-border,#213E61)] text-[var(--theme-text-dim,#94A3B8)] hover:text-[var(--theme-text,#F8FAFC)] text-[11px] flex items-center gap-1 font-semibold cursor-pointer"
                        >
                  ...
                  <div>
                    <h3 className="font-serif-display text-[18px] sm:text-[22px] font-bold text-[var(--theme-text,#F8FAFC)]">
                      {currentSection.title}
                    </h3>
                    <p className="text-[12.5px] sm:text-[13px] text-[var(--theme-text-dim,#94A3B8)] mt-1 leading-relaxed">
                ...
                {currentSection.overviewText && (
                  <div className="bg-[var(--theme-card,#132438)]/70 border border-[var(--theme-border,#213E61)] rounded-2xl p-4 sm:p-5 space-y-2 shadow-sm">
                    ...
                    <p className="text-[13px] text-[var(--theme-text-muted,#CBD5E1)] leading-relaxed">
                      {currentSection.overviewText}
                    </p>
                  </div>
                )}
                ...
                {currentSection.id === 'six_funds' ? (
                  <div className="space-y-2.5">
                    <div className="text-[13px] font-bold text-[var(--theme-text,#F8FAFC)] flex items-center gap-2">
                            ...
                            <div className="flex justify-between items-center pt-1">
                              <div className="flex items-center gap-2">
                                <div
                                  ...
                                  style={{ backgroundColor: cfg.color }}
                                />
                                <span className="font-bold text-[var(--theme-text,#F8FAFC)] text-[13px]">
                  ...
                  <div className="space-y-2.5">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      {currentSection.cards.map((c, idx) => (
                        ...
                        >
                          <div className="font-bold text-[13px] text-[var(--theme-text,#F8FAFC)] flex items-center gap-2">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                      {currentSection.steps.map((st, idx) => (
                        ...
                        >
                          ...
                          <h5 className="font-bold text-[13px] text-[var(--theme-text,#F8FAFC)]">
                            {st.title}
                          </h5>
                          <p className="text-[12px] text-[var(--theme-text-dim,#94A3B8)] leading-relaxed">
                            {st.desc}
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      {currentSection.features.map((f, idx) => (
                        <div key={idx} className="space-y-0.5">
                          <div className="font-bold text-[12.5px] text-[var(--theme-text,#F8FAFC)] flex items-center gap-1.5">
                            <span className="w-1.5 h-1.5 rounded-full bg-[var(--theme-primary,#38BDF8)]" />
                            <span>{f.title}</span>
                          </div>
                          <p className="text-[12px] text-[var(--theme-text-dim,#94A3B8)] pl-3 leading-relaxed">
                            {f.desc}
                          </p>
                        </div>
                      ))}
                    ...
                    <div className="space-y-2">
                      {currentSection.faqList.map((item, idx) => (
                        <div
                          ...
                          className="p-3.5 rounded-2xl bg-[var(--theme-bg,#070E18)] border border-[var(--theme-border,#213E61)] space-y-1 shadow-sm"
                        >
                          <div className="font-bold text-[13px] text-[var(--theme-text,#F8FAFC)] flex items-start gap-2">
                            <span className="text-[var(--theme-primary,#38BDF8)] font-mono font-bold">Q:</span>
                            <span>{item.q}</span>
                          </div>
                          <p className="text-[12px] text-[var(--theme-text-dim,#94A3B8)] pl-5 leading-relaxed">
                            {item.a}
                          </p>
                        </div>
                      ))}
                ...
                {currentSection.proTip && (
                  <div className="p-3.5 rounded-2xl bg-amber-500/10 border border-amber-500/30 flex items-start gap-3 text-amber-300">
                    ...
                    <div>
                      ...
                      <p className="text-[12.5px] text-[var(--theme-text,#F8FAFC)] mt-0.5 leading-relaxed">
                        {currentSection.proTip}
                      </p>
                    </div>
                  </div>
                ...
                {currentSection.id === 'app_lock' && onOpenSecurityLock && (
                  <button
                    ...
                    className="w-full py-3 px-4 rounded-xl bg-[#10B981]/15 border border-[#10B981]/40 text-[var(--theme-text,#F8FAFC)] hover:border-[#10B981] font-bold text-[13px] flex items-center justify-center gap-2 transition-all cursor-pointer shadow-sm"
                  >
                ...
                {currentSection.id === 'invoice_generator' && onNavigateTab && (
                  <button
                    ...
                    className="w-full py-3 px-4 rounded-xl bg-[var(--theme-primary,#38BDF8)]/15 border border-[var(--theme-primary,#38BDF8)]/40 text-[var(--theme-text,#F8FAFC)] hover:border-[var(--theme-primary,#38BDF8)] font-bold text-[13px] flex items-center justify-center gap-2 transition-all cursor-pointer shadow-sm"
                  >
                ...
                {currentSection.id === 'attendance' && onNavigateTab && (
                  <button
                    ...
                    className="w-full py-3 px-4 rounded-xl bg-amber-500/15 border border-amber-500/40 text-[var(--theme-text,#F8FAFC)] hover:border-amber-500 font-bold text-[13px] flex items-center justify-center gap-2 transition-all cursor-pointer shadow-sm"
                  >
                ...
                {currentSection.id === 'loans' && onNavigateTab && (
                  <button
                    ...
                    className="w-full py-3 px-4 rounded-xl bg-blue-500/15 border border-blue-500/40 text-[var(--theme-text,#F8FAFC)] hover:border-blue-500 font-bold text-[13px] flex items-center justify-center gap-2 transition-all cursor-pointer shadow-sm"
                  >
                ...
                <div className="border-t border-[var(--theme-border,#213E61)]/70 pt-4 space-y-3">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                    {prevSection ? (
                      ...
                      >
                        <div className="w-7 h-7 rounded-lg bg-[var(--theme-bg,#070E18)] border border-[var(--theme-border,#213E61)] flex items-center justify-center text-[var(--theme-text-dim,#94A3B8)] shrink-0">
        ...
        <div className="px-4 sm:px-5 py-3 border-t border-[var(--theme-border,#213E61)] bg-[var(--theme-bg,#070E18)] flex items-center justify-between text-[11.5px] text-[#64748B] shrink-0">
          <div className="flex items-center gap-1.5">
            <AppLogo size="sm" />
            <span className="truncate">• Daily Khata Pro Official</span>
          </div>
          <button
            type="button"
            onClick={onClose}
            className="px-4 py-1.5 rounded-lg bg-[var(--theme-card,#132438)] border border-[var(--theme-border,#213E61)] text-[var(--theme-text,#F8FAFC)] hover:bg-[var(--theme-card-hover,#19304A)] text-[12px] font-bold transition-all cursor-pointer"
          >
            {manual.backToHome}
          </button>
        </div>
