        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-5 mt-5 border-t border-[var(--theme-border,#213E61)]/70">
          <div className="p-3 rounded-xl bg-[var(--theme-surface,#0E1A29)] border border-[var(--theme-border,#213E61)]">
            ...
            <div className="text-[11.5px] text-[var(--theme-text-muted,#94A3B8)] mt-1">
              {isHindi ? 'वित्तीय डेटा केवल आपके फोन/पीसी पर रहता है' : 'Financial records never leave your device'}
            </div>
          </div>
      ...
      <div className="bg-[var(--theme-card,#132438)] border-2 border-[var(--theme-primary,#38BDF8)]/40 rounded-2xl p-5 sm:p-6 shadow-md relative overflow-hidden">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2.5 mb-3">
          <div className="flex items-center gap-2.5">
            <Sliders className="w-5 h-5 text-[var(--theme-primary,#38BDF8)] shrink-0" />
            <h2 className="text-[16px] sm:text-[17px] font-bold text-[var(--theme-text,#F8FAFC)]">
              {isHindi ? 'आपकी कुकीज़ व स्टोरेज अनुमतियाँ (Consent Manager)' : 'Your Cookie & Storage Preferences'}
            </h2>
          </div>
          {consentData && (
            <span className="self-start sm:self-auto text-[10.5px] sm:text-[11px] font-mono px-2.5 py-0.5 rounded-full bg-green-500/10 text-green-400 border border-green-500/20 font-semibold shrink-0">
        ...
        <div className="space-y-3 mb-5">
          {/* 1. Essential */}
          <div className="p-3.5 sm:p-4 rounded-xl bg-[var(--theme-surface,#0E1A29)] border border-[var(--theme-border,#213E61)] space-y-2">
            <div className="flex items-center justify-between gap-2">
              <div className="flex items-center gap-2.5 min-w-0">
                ...
                <div className="flex items-center gap-1.5 flex-wrap min-w-0">
                  <span className="font-bold text-[13px] sm:text-[14px] text-[var(--theme-text,#F8FAFC)]">
                    {isHindi ? '1. अनिवार्य स्टोरेज (Strictly Necessary)' : '1. Strictly Necessary Storage'}
                  </span>
                  <span className="text-[9.5px] font-bold px-1.5 py-0.5 rounded bg-green-500/10 text-green-400 border border-green-500/20 uppercase shrink-0">
                    {isHindi ? 'आवश्यक' : 'Mandatory'}
                  </span>
                </div>
              </div>
              <span className="text-[10.5px] sm:text-[11px] font-bold text-green-400 shrink-0 px-2 py-0.5 rounded-full bg-green-500/10 border border-green-500/20 whitespace-nowrap">
                {isHindi ? 'सदा सक्रिय' : 'Always Active'}
              </span>
            </div>
            <p className="text-[11.5px] sm:text-[12px] text-[var(--theme-text-dim,#94A3B8)] pl-10.5 sm:pl-11 leading-relaxed">
              {isHindi
                ? 'आपके खाते, आय-व्यय प्रविष्टियां, 6-फंड लेज़र, और पिन लॉक पासकोड को डिवाइस पर सुरक्षित रखने के लिए अपरिहार्य है।'
                : 'Required for core accounting records, offline transactions, balance calculations, and PIN passcode security.'}
            </p>
          </div>
          ...
          <div className="p-3.5 sm:p-4 rounded-xl bg-[var(--theme-surface,#0E1A29)] border border-[var(--theme-border,#213E61)] space-y-2">
            <div className="flex items-center justify-between gap-2">
              <div className="flex items-center gap-2.5 min-w-0">
                ...
                <span className="font-bold text-[13px] sm:text-[14px] text-[var(--theme-text,#F8FAFC)] truncate">
                  {isHindi ? '2. कार्यक्षमता व थीम पसंद (Preferences)' : '2. Functional & Interface Preferences'}
                </span>
              </div>
            ...
            <table className="w-full text-left text-[12px] border-collapse">
              ...
              <tbody className="divide-y divide-[var(--theme-border,#213E61)]/50 text-[var(--theme-text-muted,#94A3B8)]">
                <tr>
                  ...
                  <td className="py-2.5 px-3">{isHindi ? 'आपकी सभी आय, व्यय और 6-फंड प्रविष्टियां' : 'Financial entries, amounts, fund distribution'}</td>
