      ...
      >
        ...
        <div className="p-4 sm:p-5 overflow-y-auto space-y-4 flex-1">
          ...
          <div className="space-y-1">
            <label className="text-[12px] font-bold text-[var(--theme-text-muted,#CBD5E1)] block">
            ...
            <input
              ...
              className="w-full bg-[var(--theme-surface,#0E1A29)] border border-[var(--theme-border,#213E61)] rounded-xl px-3.5 py-2 text-[13px] text-[var(--theme-text,#F8FAFC)] focus:outline-none focus:border-[var(--theme-primary,#38BDF8)]"
            />
          </div>
          ...
          <div className="space-y-1">
            <div className="flex items-center justify-between">
              <label className="text-[12px] font-bold text-[var(--theme-text-muted,#CBD5E1)]">
            ...
            <div className="flex items-center gap-3">
              ...
              <input
                ...
                className="w-16 bg-[var(--theme-surface,#0E1A29)] border border-[var(--theme-border,#213E61)] rounded-lg px-2 py-1 text-right text-[13px] font-mono font-bold text-[var(--theme-text,#F8FAFC)] focus:outline-none"
              />
            </div>
          </div>
          ...
          <div className="space-y-1.5 pt-1">
            <label className="text-[12px] font-bold text-[var(--theme-text-muted,#CBD5E1)] flex items-center gap-1.5">
        ...
        <div className="p-4 border-t border-[var(--theme-border,#213E61)] bg-[var(--theme-surface,#0E1A29)] flex items-center justify-end gap-2">
          <button
            type="button"
            onClick={onClose}
            className="px-4 py-2 rounded-xl bg-[var(--theme-card,#132438)] border border-[var(--theme-border,#213E61)] text-[var(--theme-text-muted,#CBD5E1)] hover:text-[var(--theme-text,#F8FAFC)] font-semibold text-[12px] cursor-pointer"
          >
